...
var BN6__default = /*#__PURE__*/_interopDefault(BN6);
...
var AddressType = beet201.uniformFixedSizeArray(beet201.u8, 32);
...
var LzReceiveParamsBeet = new beet201.FixableBeetArgsStruct(
  [
    ["srcEid", beet201.u32],
    ["sender", beet201.uniformFixedSizeArray(beet201.u8, 32)],
    ["nonce", beet201.u64],
    ["guid", beet201.uniformFixedSizeArray(beet201.u8, 32)],
    ["message", beet201.bytes],
    ["callerParams", beet201.bytes]
  ],
  "LzReceiveParams"
);
var LzComposeParamsBeet = new beet201.FixableBeetArgsStruct(
  [
    ["from", beetSolana97__namespace.publicKey],
    ["to", beetSolana97__namespace.publicKey],
    ["guid", beet201.uniformFixedSizeArray(beet201.u8, 32)],
    ["index", beet201.u16],
    ["message", beet201.bytes],
    ["extraData", beet201.bytes]
  ],
  "LzComposeParams"
);
var LzReceiveAccountBeet = new beet201.BeetArgsStruct(
  [
    ["pubkey", beetSolana97__namespace.publicKey],
    ["isSigner", beet201.bool],
    ["isWritable", beet201.bool]
  ],
  "LzReceiveAccount"
);
...
function oappIDPDA(program, seed = COUNT_SEED, id) {
  if (id != void 0) {
    return web35.PublicKey.findProgramAddressSync(
      [Buffer.from(seed, "utf8"), new BN6__default.default(id).toArrayLike(Buffer, "be", 1)],
      program
    );
  } else {
    return web35.PublicKey.findProgramAddressSync([Buffer.from(seed, "utf8")], program);
  }
}
function deriveLzReceiveTypesAccountsPDA(program, oappId) {
  if (oappId != void 0) {
    return web35.PublicKey.findProgramAddressSync([Buffer.from(LZ_RECEIVE_TYPES_SEED, "utf8"), oappId.toBytes()], program);
  }
  return web35.PublicKey.findProgramAddressSync([Buffer.from(LZ_RECEIVE_TYPES_SEED, "utf8")], program);
}
function deriveLzComposeTypesAccountsPDA(program, oappId) {
  if (oappId != void 0) {
    return web35.PublicKey.findProgramAddressSync([Buffer.from(LZ_COMPOSE_TYPES_SEED, "utf8"), oappId.toBytes()], program);
  }
  return web35.PublicKey.findProgramAddressSync([Buffer.from(LZ_COMPOSE_TYPES_SEED, "utf8")], program);
}
var BaseOApp = class {
  constructor(program) {
...
var EnforcedOptions = class _EnforcedOptions {
   ...
   */
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    "HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW"
  )) {
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, enforcedOptionsBeet);
  }
  /**
...
var enforcedOptionsBeet = new beet201__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["send", beet201__namespace.bytes],
    ["sendAndCall", beet201__namespace.bytes],
    ["bump", beet201__namespace.u8]
  ],
...
var LzReceiveTypesAccounts = class _LzReceiveTypesAccounts {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(
      programId,
...
var lzReceiveTypesAccountsBeet = new beet201__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["oftConfig", beetSolana97__namespace.publicKey],
    ["tokenMint", beetSolana97__namespace.publicKey]
  ],
...
var oftConfigExtBeet = beet201__namespace.dataEnum([
  [
    "Native",
    new beet201__namespace.FixableBeetArgsStruct(
      [["fields", beet201__namespace.tuple([beet201__namespace.coption(beetSolana97__namespace.publicKey)])]],
      'OftConfigExtRecord["Native"]'
    )
  ],
  [
    "Adapter",
    new beet201__namespace.BeetArgsStruct(
      [["fields", beet201__namespace.fixedSizeTuple([beetSolana97__namespace.publicKey])]],
...
var OftConfig = class _OftConfig {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, oftConfigBeet);
  }
  /**
...
var oftConfigBeet = new beet201__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["ld2sdRate", beet201__namespace.u64],
    ["tokenMint", beetSolana97__namespace.publicKey],
    ["tokenProgram", beetSolana97__namespace.publicKey],
    ["endpointProgram", beetSolana97__namespace.publicKey],
    ["bump", beet201__namespace.u8],
...
var rateLimiterBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["capacity", beet201__namespace.u64],
    ["tokens", beet201__namespace.u64],
    ["refillPerSecond", beet201__namespace.u64],
    ["lastRefillTime", beet201__namespace.u64]
  ],
  "RateLimiter"
);
...
var Peer = class _Peer {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, peerBeet);
  }
  /**
...
var peerBeet = new beet201__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["address", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["rateLimiter", beet201__namespace.coption(rateLimiterBeet)],
    ["bump", beet201__namespace.u8]
  ],
  Peer.fromArgs,
  "Peer"
...
// src/generated/oft/errors/index.ts
...
createErrorFromCodeLookup.set(6e3, () => new UnauthorizedError());
createErrorFromNameLookup.set("Unauthorized", () => new UnauthorizedError());
var InvalidSenderError = class _InvalidSenderError extends Error {
  constructor() {
    super("");
    this.code = 6001;
    this.name = "InvalidSender";
    if (typeof Error.captureStackTrace === "function") {
      Error.captureStackTrace(this, _InvalidSenderError);
    }
  }
};
createErrorFromCodeLookup.set(6001, () => new InvalidSenderError());
createErrorFromNameLookup.set("InvalidSender", () => new InvalidSenderError());
var InvalidDecimalsError = class _InvalidDecimalsError extends Error {
  constructor() {
    super("");
    this.code = 6002;
    this.name = "InvalidDecimals";
    if (typeof Error.captureStackTrace === "function") {
      Error.captureStackTrace(this, _InvalidDecimalsError);
    }
  }
};
createErrorFromCodeLookup.set(6002, () => new InvalidDecimalsError());
createErrorFromNameLookup.set(
  "InvalidDecimals",
  () => new InvalidDecimalsError()
);
var SlippageExceededError = class _SlippageExceededError extends Error {
  constructor() {
    super("");
    this.code = 6003;
    this.name = "SlippageExceeded";
    if (typeof Error.captureStackTrace === "function") {
      Error.captureStackTrace(this, _SlippageExceededError);
    }
  }
};
createErrorFromCodeLookup.set(6003, () => new SlippageExceededError());
createErrorFromNameLookup.set(
  "SlippageExceeded",
  () => new SlippageExceededError()
);
var InvalidTokenMintError = class _InvalidTokenMintError extends Error {
  constructor() {
    super("");
    this.code = 6004;
    this.name = "InvalidTokenMint";
    if (typeof Error.captureStackTrace === "function") {
      Error.captureStackTrace(this, _InvalidTokenMintError);
    }
  }
};
createErrorFromCodeLookup.set(6004, () => new InvalidTokenMintError());
createErrorFromNameLookup.set(
  "InvalidTokenMint",
  () => new InvalidTokenMintError()
);
var InvalidTokenEscrowError = class _InvalidTokenEscrowError extends Error {
  constructor() {
    super("");
    this.code = 6005;
    this.name = "InvalidTokenEscrow";
    if (typeof Error.captureStackTrace === "function") {
      Error.captureStackTrace(this, _InvalidTokenEscrowError);
    }
  }
};
createErrorFromCodeLookup.set(6005, () => new InvalidTokenEscrowError());
createErrorFromNameLookup.set(
  "InvalidTokenEscrow",
  () => new InvalidTokenEscrowError()
);
var InvalidTokenDestError = class _InvalidTokenDestError extends Error {
  constructor() {
    super("");
    this.code = 6006;
    this.name = "InvalidTokenDest";
    if (typeof Error.captureStackTrace === "function") {
      Error.captureStackTrace(this, _InvalidTokenDestError);
    }
  }
};
createErrorFromCodeLookup.set(6006, () => new InvalidTokenDestError());
createErrorFromNameLookup.set(
  "InvalidTokenDest",
  () => new InvalidTokenDestError()
);
var InvalidOptionsError = class _InvalidOptionsError extends Error {
  constructor() {
    super("");
    this.code = 6007;
    this.name = "InvalidOptions";
    if (typeof Error.captureStackTrace === "function") {
      Error.captureStackTrace(this, _InvalidOptionsError);
    }
  }
};
createErrorFromCodeLookup.set(6007, () => new InvalidOptionsError());
createErrorFromNameLookup.set("InvalidOptions", () => new InvalidOptionsError());
var InvalidEndpointProgramError = class _InvalidEndpointProgramError extends Error {
  constructor() {
    super("");
    this.code = 6008;
    this.name = "InvalidEndpointProgram";
    if (typeof Error.captureStackTrace === "function") {
      Error.captureStackTrace(this, _InvalidEndpointProgramError);
    }
  }
};
createErrorFromCodeLookup.set(6008, () => new InvalidEndpointProgramError());
createErrorFromNameLookup.set(
  "InvalidEndpointProgram",
  () => new InvalidEndpointProgramError()
);
var RateLimitExceededError = class _RateLimitExceededError extends Error {
  constructor() {
    super("");
    this.code = 6009;
    this.name = "RateLimitExceeded";
    if (typeof Error.captureStackTrace === "function") {
      Error.captureStackTrace(this, _RateLimitExceededError);
    }
  }
};
createErrorFromCodeLookup.set(6009, () => new RateLimitExceededError());
createErrorFromNameLookup.set(
  "RateLimitExceeded",
...
var initAdapterOftParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["admin", beetSolana97__namespace.publicKey],
    ["sharedDecimals", beet201__namespace.u8],
    ["endpointProgram", beet201__namespace.coption(beetSolana97__namespace.publicKey)]
  ],
  "InitAdapterOftParams"
);

// src/generated/oft/instructions/initAdapterOft.ts
var initAdapterOftStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
...
function createInitAdapterOftInstruction(accounts, args, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
  ...
  const keys = [
    ...
    {
      pubkey: accounts.systemProgram ?? web35__namespace.SystemProgram.programId,
      isWritable: false,
      isSigner: false
    }
  ];
...
function createInitAdapterOftInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
  const keys = [
    {
      pubkey: accounts.payer,
      isWritable: true,
...
var initOftParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["admin", beetSolana97__namespace.publicKey],
    ["sharedDecimals", beet201__namespace.u8],
    ["endpointProgram", beet201__namespace.coption(beetSolana97__namespace.publicKey)],
    ["mintAuthority", beet201__namespace.coption(beetSolana97__namespace.publicKey)]
  ],
  "InitOftParams"
);

// src/generated/oft/instructions/initOft.ts
var initOftStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitOftInstruction(accounts, args, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
...
function createInitOftInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
  const keys = [
    {
      pubkey: accounts.payer,
      isWritable: true,
...
var lzReceiveParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["srcEid", beet201__namespace.u32],
    ["sender", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["nonce", beet201__namespace.u64],
    ["guid", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["message", beet201__namespace.bytes],
    ["extraData", beet201__namespace.bytes]
  ],
  "LzReceiveParams"
);

// src/generated/oft/instructions/lzReceive.ts
var lzReceiveStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createLzReceiveInstruction(accounts, args, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
...
function createLzReceiveInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
  const keys = [
    {
      pubkey: accounts.payer,
      isWritable: true,
...
var lzReceiveTypesStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["params", lzReceiveParamsBeet]
  ],
...
function createLzReceiveTypesInstruction(accounts, args, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
...
function createLzReceiveTypesInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
  const keys = [
    {
      pubkey: accounts.oftConfig,
      isWritable: false,
...
var mintToParamsBeet = new beet201__namespace.BeetArgsStruct(
  [["amount", beet201__namespace.u64]],
  "MintToParams"
);

// src/generated/oft/instructions/mintTo.ts
var mintToStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createMintToInstruction(accounts, args, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
...
function createMintToInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
  const keys = [
    {
      pubkey: accounts.minter,
      isWritable: false,
...
var quoteParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["dstEid", beet201__namespace.u32],
    ["to", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["amountLd", beet201__namespace.u64],
    ["minAmountLd", beet201__namespace.u64],
    ["options", beet201__namespace.bytes],
    ["composeMsg", beet201__namespace.coption(beet201__namespace.bytes)],
    ["payInLzToken", beet201__namespace.bool]
  ],
  "QuoteParams"
);

// src/generated/oft/instructions/quote.ts
var quoteStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createQuoteInstruction(accounts, args, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
...
function createQuoteInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
  const keys = [
    {
      pubkey: accounts.oftConfig,
      isWritable: false,
...
var quoteOftParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["dstEid", beet201__namespace.u32],
    ["to", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["amountLd", beet201__namespace.u64],
...
var quoteOftStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createQuoteOftInstruction(accounts, args, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
...
function createQuoteOftInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
  const keys = [
    {
      pubkey: accounts.oftConfig,
      isWritable: false,
...
var sendParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["dstEid", beet201__namespace.u32],
    ["to", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["amountLd", beet201__namespace.u64],
    ...
    ["options", beet201__namespace.bytes],
    ["composeMsg", beet201__namespace.coption(beet201__namespace.bytes)],
    ["nativeFee", beet201__namespace.u64],
    ["lzTokenFee", beet201__namespace.u64]
  ],
  "SendParams"
);

// src/generated/oft/instructions/send.ts
var sendStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSendInstruction(accounts, args, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
...
function createSendInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
  const keys = [
    {
      pubkey: accounts.signer,
      isWritable: false,
...
var setDelegateParamsBeet = new beet201__namespace.BeetArgsStruct(
  [["delegate", beetSolana97__namespace.publicKey]],
  "SetDelegateParams"
);

// src/generated/oft/instructions/setDelegate.ts
var setDelegateStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetDelegateInstruction(accounts, args, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
...
function createSetDelegateInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var setEnforcedOptionsParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["dstEid", beet201__namespace.u32],
    ["send", beet201__namespace.bytes],
    ["sendAndCall", beet201__namespace.bytes]
...
var setEnforcedOptionsStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetEnforcedOptionsInstruction(accounts, args, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
...
function createSetEnforcedOptionsInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: true,
...
var setMintAuthorityParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [["mintAuthority", beet201__namespace.coption(beetSolana97__namespace.publicKey)]],
  "SetMintAuthorityParams"
);

// src/generated/oft/instructions/setMintAuthority.ts
var setMintAuthorityStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetMintAuthorityInstruction(accounts, args, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
...
function createSetMintAuthorityInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
  const keys = [
    {
      pubkey: accounts.signer,
      isWritable: false,
...
var setPeerParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["dstEid", beet201__namespace.u32],
    ["peer", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)]
  ],
  "SetPeerParams"
);

// src/generated/oft/instructions/setPeer.ts
var setPeerStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetPeerInstruction(accounts, args, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
...
function createSetPeerInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: true,
...
var setRateLimitParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["dstEid", beet201__namespace.u32],
    ["refillPerSecond", beet201__namespace.coption(beet201__namespace.u64)],
    ["capacity", beet201__namespace.coption(beet201__namespace.u64)],
    ["enabled", beet201__namespace.bool]
  ],
  "SetRateLimitParams"
);

// src/generated/oft/instructions/setRateLimit.ts
var setRateLimitStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetRateLimitInstruction(accounts, args, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
...
function createSetRateLimitInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var transferAdminParamsBeet = new beet201__namespace.BeetArgsStruct(
  [["admin", beetSolana97__namespace.publicKey]],
  "TransferAdminParams"
);

// src/generated/oft/instructions/transferAdmin.ts
var transferAdminStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createTransferAdminInstruction(accounts, args, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
...
function createTransferAdminInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var versionStruct = new beet201__namespace.BeetArgsStruct(
  [["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)]],
...
function createVersionInstruction(programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
...
function createVersionInstructionAccounts(programId = new web35__namespace.PublicKey("HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW")) {
  const keys = [];
  return keys;
}
var lzAccountBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["pubkey", beetSolana97__namespace.publicKey],
    ["isSigner", beet201__namespace.bool],
    ["isWritable", beet201__namespace.bool]
  ],
  "LzAccount"
);
var messagingFeeBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["nativeFee", beet201__namespace.u64],
    ["lzTokenFee", beet201__namespace.u64]
  ],
...
var messagingReceiptBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["guid", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["nonce", beet201__namespace.u64],
...
var oFTFeeDetailBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["feeAmountLd", beet201__namespace.u64],
    ["description", beet201__namespace.utf8String]
  ],
  "OFTFeeDetail"
);
var oFTLimitsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["minAmountLd", beet201__namespace.u64],
    ["maxAmountLd", beet201__namespace.u64]
  ],
  "OFTLimits"
);
var oFTReceiptBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["amountSentLd", beet201__namespace.u64],
    ["amountReceivedLd", beet201__namespace.u64]
  ],
  "OFTReceipt"
);
var quoteOftResultBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["oftLimits", oFTLimitsBeet],
    ["oftFeeDetails", beet201__namespace.array(oFTFeeDetailBeet)],
    ["oftReceipt", oFTReceiptBeet]
  ],
  "QuoteOftResult"
);
var versionBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["sdkVersion", beet201__namespace.u64],
    ["oftVersion", beet201__namespace.u64]
  ],
  "Version"
);

// src/generated/oft/index.ts
var PROGRAM_ADDRESS = "HRPXLCqspQocTjfcX4rvAPaY9q6Gwb1rrD3xXWrfJWdW";
var PROGRAM_ID = new web35.PublicKey(PROGRAM_ADDRESS);
...
var EndpointPDADeriver = class {
  ...
  setting() {
    return web35.PublicKey.findProgramAddressSync([Buffer.from(ENDPOINT_SEED, "utf8")], this.program);
  }
  defaultSendLibraryConfig(dstEndpointId) {
    return web35.PublicKey.findProgramAddressSync(
      [
        ...
        new BN6__default.default(dstEndpointId).toArrayLike(Buffer, "be", 4)
      ],
      this.program
    );
  }
  ...
  defaultReceiveLibraryConfig(srcEndpointId) {
    return web35.PublicKey.findProgramAddressSync(
      [
        ...
        // U32 to Uint8Array([0,0,0,0])
        new BN6__default.default(srcEndpointId).toArrayLike(Buffer, "be", 4)
      ],
      this.program
    );
  }
  ...
  defaultMessageLib() {
    return this.messageLibraryInfo(web35.PublicKey.default);
  }
  ...
  nonce(localOapp, remoteChainId, remoteOapp) {
    return web35.PublicKey.findProgramAddressSync(
      [
        ...
        localOapp.toBytes(),
        // U32 to Uint8Array([0,0,0,0])
        new BN6__default.default(remoteChainId).toArrayLike(Buffer, "be", 4),
        remoteOapp
      ],
      this.program
    );
  ...
  oappRegistry(localOapp) {
    return web35.PublicKey.findProgramAddressSync([Buffer.from(OAPP_SEED, "utf8"), localOapp.toBytes()], this.program);
  }
  /***
   * @param receiver
   * @param srcEid
  ...
  payloadHash(receiver, srcEid, sender, nonce) {
    return web35.PublicKey.findProgramAddressSync(
      [
        ...
        receiver.toBytes(),
        new BN6__default.default(srcEid).toArrayLike(Buffer, "be", 4),
        sender,
        new BN6__default.default(nonce).toArrayLike(Buffer, "be", 8)
      ],
      this.program
    );
  }
  composedMessage(from, guid, index, to, messageHash) {
    return web35.PublicKey.findProgramAddressSync(
      [
        ...
        to.toBytes(),
        guid,
        new BN6__default.default(index).toArrayLike(Buffer, "be", 2),
        messageHash
      ],
      this.program
    );
...
var MessageLibPDADeriver = class {
  ...
  messageLib() {
    return web35.PublicKey.findProgramAddressSync([Buffer.from(MESSAGE_LIB_SEED, "utf8")], this.program);
  }
  sendConfig(eid, oapp) {
    return web35.PublicKey.findProgramAddressSync(
      [Buffer.from(SEND_CONFIG_SEED, "utf8"), new BN6__default.default(eid).toArrayLike(Buffer, "be", 4), oapp.toBuffer()],
      this.program
    );
  }
  receiveConfig(eid, oapp) {
    return web35.PublicKey.findProgramAddressSync(
      [Buffer.from(RECEIVE_CONFIG_SEED, "utf8"), new BN6__default.default(eid).toArrayLike(Buffer, "be", 4), oapp.toBuffer()],
      this.program
    );
  }
};
var UlnPDADeriver = class extends MessageLibPDADeriver {
  setting() {
    return web35.PublicKey.findProgramAddressSync([Buffer.from(ULN_SEED, "utf8")], this.program);
  }
  config(eid) {
    return web35.PublicKey.findProgramAddressSync(
      [Buffer.from(ULN_CONFIG_SEED, "utf8"), new BN6__default.default(eid).toArrayLike(Buffer, "be", 4)],
      this.program
    );
  }
  defaultSendConfig(eid) {
    return web35.PublicKey.findProgramAddressSync(
      [Buffer.from(SEND_CONFIG_SEED, "utf8"), new BN6__default.default(eid).toArrayLike(Buffer, "be", 4)],
      this.program
    );
  }
  defaultReceiveConfig(eid) {
    return web35.PublicKey.findProgramAddressSync(
      [Buffer.from(RECEIVE_CONFIG_SEED, "utf8"), new BN6__default.default(eid).toArrayLike(Buffer, "be", 4)],
      this.program
    );
  }
  options(eit) {
    return web35.PublicKey.findProgramAddressSync(
      [Buffer.from(OPTIONS_SEED, "utf8"), new BN6__default.default(eit).toArrayLike(Buffer, "be", 4)],
      this.program
    );
  }
  workerConfig(worker) {
    return web35.PublicKey.findProgramAddressSync([Buffer.from(WORKER_SEED, "utf8"), worker.toBuffer()], this.program);
  }
...
var OAppBasePDADeriver = class {
  ...
  remote(dstChainId) {
    return web35.PublicKey.findProgramAddressSync(
      [Buffer.from(REMOTE_SEED), new BN6__default.default(dstChainId).toArrayLike(Buffer, "be", 4)],
      this.program
    );
  }
  lzReceiveTypesAccounts() {
    return web35.PublicKey.findProgramAddressSync([Buffer.from(LZ_RECEIVE_TYPES_SEED, "utf8")], this.program);
  }
  lzComposeTypesAccounts() {
    return web35.PublicKey.findProgramAddressSync([Buffer.from(LZ_COMPOSE_TYPES_SEED, "utf8")], this.program);
  }
};
var OmniCounterPDADeriver = class extends OAppBasePDADeriver {
  constructor(program, counterId) {
    super(program);
  ...
  remote(dstChainId) {
    return web35.PublicKey.findProgramAddressSync(
      [Buffer.from(REMOTE_SEED), this.count()[0].toBytes(), new BN6__default.default(dstChainId).toArrayLike(Buffer, "be", 4)],
      this.program
    );
  }
  lzReceiveTypesAccounts() {
...
var DVNDeriver = class {
  ...
  authority() {
    return web35.PublicKey.findProgramAddressSync([Buffer.from("dvn", "utf8")], this.program);
  }
  config() {
    return web35.PublicKey.findProgramAddressSync([Buffer.from(DVN_CONFIG_SEED, "utf8")], this.program);
  }
  executeHash(digestHash) {
    return web35.PublicKey.findProgramAddressSync([Buffer.from("ExecuteHash", "utf8"), digestHash], this.program);
  }
};
var EventPDADeriver = class {
  ...
  eventAuthority() {
    return web35.PublicKey.findProgramAddressSync([Buffer.from(EVENT_SEED, "utf8")], this.program);
  }
};
var ExecutorPDADeriver = class {
  ...
  config() {
    return web35.PublicKey.findProgramAddressSync([Buffer.from(EXECUTOR_CONFIG_SEED, "utf8")], this.program);
  }
};
var PriceFeedPDADeriver = class {
  ...
  priceFeed() {
    return web35.PublicKey.findProgramAddressSync([Buffer.from(PRICE_FEED_SEED, "utf8")], this.program);
  }
};
var OftPDADeriver = class {
  constructor(program = PROGRAM_ID) {
    this.program = program;
  }
  config() {
    return web35.PublicKey.findProgramAddressSync([Buffer.from("OftConfig", "utf8")], this.program);
  }
  enforcedOptions(oftConfig, eid) {
    return web35.PublicKey.findProgramAddressSync(
      [Buffer.from(ENFORCED_OPTIONS_SEED, "utf8"), oftConfig.toBytes(), new BN6__default.default(eid).toArrayLike(Buffer, "be", 4)],
      this.program
    );
  }
  peer(oftConfig, eid) {
    return web35.PublicKey.findProgramAddressSync(
      [Buffer.from(PEER_SEED, "utf8"), oftConfig.toBytes(), new BN6__default.default(eid).toArrayLike(Buffer, "be", 4)],
      this.program
    );
  }
...
function addressToBytes32(address) {
  if (isSolanaAddress(address)) {
    return new web35.PublicKey(address).toBytes();
...
var ComposeMessageState = class _ComposeMessageState {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, composeMessageStateBeet);
  }
  /**
...
var composeMessageStateBeet = new beet201__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["received", beet201__namespace.bool],
    ["bump", beet201__namespace.u8]
  ],
...
var EndpointSettings = class _EndpointSettings {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, endpointSettingsBeet);
  }
  /**
...
var endpointSettingsBeet = new beet201__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["eid", beet201__namespace.u32],
    ["bump", beet201__namespace.u8],
    ["admin", beetSolana97__namespace.publicKey],
    ["lzTokenMint", beet201__namespace.coption(beetSolana97__namespace.publicKey)]
  ],
...
var messageLibTypeBeet = beet201__namespace.fixedScalarEnum(
  MessageLibType
);
...
var MessageLibInfo = class _MessageLibInfo {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, messageLibInfoBeet);
  }
  /**
...
var messageLibInfoBeet = new beet201__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["messageLibType", messageLibTypeBeet],
    ["bump", beet201__namespace.u8],
    ["messageLibBump", beet201__namespace.u8]
  ],
...
var Nonce = class _Nonce {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, nonceBeet);
  }
  /**
...
var nonceBeet = new beet201__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["bump", beet201__namespace.u8],
    ["outboundNonce", beet201__namespace.u64],
    ["inboundNonce", beet201__namespace.u64]
  ],
  Nonce.fromArgs,
  "Nonce"
);
...
var OAppRegistry = class _OAppRegistry {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, oAppRegistryBeet);
  }
  /**
...
var oAppRegistryBeet = new beet201__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["delegate", beetSolana97__namespace.publicKey],
    ["bump", beet201__namespace.u8]
...
var PayloadHash = class _PayloadHash {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, payloadHashBeet);
  }
  /**
...
var payloadHashBeet = new beet201__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["hash", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["bump", beet201__namespace.u8]
  ],
...
var PendingInboundNonce = class _PendingInboundNonce {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, pendingInboundNonceBeet);
  }
  /**
...
var pendingInboundNonceBeet = new beet201__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["nonces", beet201__namespace.array(beet201__namespace.u64)],
    ["bump", beet201__namespace.u8]
  ],
  PendingInboundNonce.fromArgs,
  "PendingInboundNonce"
);
var receiveLibraryTimeoutBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["messageLib", beetSolana97__namespace.publicKey],
    ["expiry", beet201__namespace.u64]
  ],
...
var ReceiveLibraryConfig = class _ReceiveLibraryConfig {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, receiveLibraryConfigBeet);
  }
  /**
...
var receiveLibraryConfigBeet = new beet201__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["messageLib", beetSolana97__namespace.publicKey],
    ["timeout", beet201__namespace.coption(receiveLibraryTimeoutBeet)],
    ["bump", beet201__namespace.u8]
  ],
...
var SendLibraryConfig = class _SendLibraryConfig {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, sendLibraryConfigBeet);
  }
  /**
...
var sendLibraryConfigBeet = new beet201__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["messageLib", beetSolana97__namespace.publicKey],
    ["bump", beet201__namespace.u8]
...
createErrorFromCodeLookup2.set(6e3, () => new InvalidSendLibraryError());
...
createErrorFromCodeLookup2.set(6001, () => new InvalidReceiveLibraryError());
createErrorFromNameLookup2.set(
...
createErrorFromCodeLookup2.set(6002, () => new SameValueError());
createErrorFromNameLookup2.set("SameValue", () => new SameValueError());
...
createErrorFromCodeLookup2.set(6003, () => new AccountNotFoundError());
createErrorFromNameLookup2.set(
  "AccountNotFound",
...
createErrorFromCodeLookup2.set(6004, () => new OnlySendLibError());
createErrorFromNameLookup2.set("OnlySendLib", () => new OnlySendLibError());
...
createErrorFromCodeLookup2.set(6005, () => new OnlyReceiveLibError());
createErrorFromNameLookup2.set("OnlyReceiveLib", () => new OnlyReceiveLibError());
...
createErrorFromCodeLookup2.set(6006, () => new InvalidExpiryError());
createErrorFromNameLookup2.set("InvalidExpiry", () => new InvalidExpiryError());
...
createErrorFromCodeLookup2.set(6007, () => new OnlyNonDefaultLibError());
createErrorFromNameLookup2.set(
  "OnlyNonDefaultLib",
...
createErrorFromCodeLookup2.set(6008, () => new InvalidAmountError());
createErrorFromNameLookup2.set("InvalidAmount", () => new InvalidAmountError());
...
createErrorFromCodeLookup2.set(6009, () => new InvalidNonceError());
createErrorFromNameLookup2.set("InvalidNonce", () => new InvalidNonceError());
...
createErrorFromCodeLookup2.set(6010, () => new UnauthorizedError2());
createErrorFromNameLookup2.set("Unauthorized", () => new UnauthorizedError2());
...
createErrorFromCodeLookup2.set(6011, () => new PayloadHashNotFoundError());
createErrorFromNameLookup2.set(
  "PayloadHashNotFound",
...
createErrorFromCodeLookup2.set(6012, () => new ComposeNotFoundError());
createErrorFromNameLookup2.set(
  "ComposeNotFound",
...
createErrorFromCodeLookup2.set(6013, () => new InvalidPayloadHashError());
createErrorFromNameLookup2.set(
  "InvalidPayloadHash",
...
createErrorFromCodeLookup2.set(6014, () => new LzTokenUnavailableError());
createErrorFromNameLookup2.set(
  "LzTokenUnavailable",
...
createErrorFromCodeLookup2.set(6015, () => new ReadOnlyAccountError());
createErrorFromNameLookup2.set(
  "ReadOnlyAccount",
...
createErrorFromCodeLookup2.set(6016, () => new InvalidMessageLibError());
createErrorFromNameLookup2.set(
  "InvalidMessageLib",
...
createErrorFromCodeLookup2.set(
  6017,
...
var burnParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["srcEid", beet201__namespace.u32],
    ["sender", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["nonce", beet201__namespace.u64],
...
var burnStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createBurnInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createBurnInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.signer,
      isWritable: false,
...
var clearParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["srcEid", beet201__namespace.u32],
    ["sender", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
...
var clearStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createClearInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createClearInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.signer,
      isWritable: false,
...
var clearComposeParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["from", beetSolana97__namespace.publicKey],
    ["guid", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["index", beet201__namespace.u16],
    ["message", beet201__namespace.bytes]
  ],
  "ClearComposeParams"
);
...
var clearComposeStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createClearComposeInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createClearComposeInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.to,
      isWritable: false,
...
var initConfigParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["oapp", beetSolana97__namespace.publicKey],
    ["eid", beet201__namespace.u32]
  ],
  "InitConfigParams"
);
...
var initConfigStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitConfigInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createInitConfigInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.delegate,
      isWritable: false,
...
var initDefaultReceiveLibraryParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["newLib", beetSolana97__namespace.publicKey]
  ],
  "InitDefaultReceiveLibraryParams"
);

// src/generated/endpoint/instructions/initDefaultReceiveLibrary.ts
var initDefaultReceiveLibraryStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitDefaultReceiveLibraryInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createInitDefaultReceiveLibraryInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: true,
...
var initDefaultSendLibraryParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["newLib", beetSolana97__namespace.publicKey]
  ],
...
var initDefaultSendLibraryStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitDefaultSendLibraryInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createInitDefaultSendLibraryInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: true,
...
var initEndpointParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["admin", beetSolana97__namespace.publicKey]
  ],
...
var initEndpointStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitEndpointInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createInitEndpointInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.payer,
      isWritable: true,
...
var initNonceParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["localOapp", beetSolana97__namespace.publicKey],
    ["remoteEid", beet201__namespace.u32],
    ["remoteOapp", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)]
  ],
  "InitNonceParams"
);

// src/generated/endpoint/instructions/initNonce.ts
var initNonceStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitNonceInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createInitNonceInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.delegate,
      isWritable: true,
...
var initReceiveLibraryParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["eid", beet201__namespace.u32]
  ],
...
var initReceiveLibraryStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitReceiveLibraryInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createInitReceiveLibraryInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.delegate,
      isWritable: true,
...
var initSendLibraryParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["sender", beetSolana97__namespace.publicKey],
    ["eid", beet201__namespace.u32]
  ],
...
var initSendLibraryStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitSendLibraryInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createInitSendLibraryInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.delegate,
      isWritable: true,
...
var initVerifyParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["srcEid", beet201__namespace.u32],
    ["sender", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["receiver", beetSolana97__namespace.publicKey],
...
var initVerifyStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitVerifyInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createInitVerifyInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.payer,
      isWritable: true,
...
var lzComposeAlertParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["from", beetSolana97__namespace.publicKey],
    ["to", beetSolana97__namespace.publicKey],
    ["guid", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["index", beet201__namespace.u16],
    ["computeUnits", beet201__namespace.u64],
    ["value", beet201__namespace.u64],
    ["message", beet201__namespace.bytes],
    ["extraData", beet201__namespace.bytes],
    ["reason", beet201__namespace.bytes]
  ],
  "LzComposeAlertParams"
);

// src/generated/endpoint/instructions/lzComposeAlert.ts
var lzComposeAlertStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createLzComposeAlertInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createLzComposeAlertInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.executor,
      isWritable: false,
...
var lzReceiveAlertParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["srcEid", beet201__namespace.u32],
    ["sender", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
...
var lzReceiveAlertStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createLzReceiveAlertInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createLzReceiveAlertInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.executor,
      isWritable: false,
...
var nilifyParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["srcEid", beet201__namespace.u32],
    ["sender", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
...
var nilifyStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createNilifyInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createNilifyInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.signer,
      isWritable: false,
...
var quoteParamsBeet2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["sender", beetSolana97__namespace.publicKey],
    ["dstEid", beet201__namespace.u32],
    ["receiver", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["message", beet201__namespace.bytes],
    ["options", beet201__namespace.bytes],
    ["payInLzToken", beet201__namespace.bool]
  ],
...
var quoteStruct2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createQuoteInstruction2(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createQuoteInstructionAccounts2(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.sendLibraryProgram,
      isWritable: false,
...
var registerLibraryParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["libProgram", beetSolana97__namespace.publicKey],
...
var registerLibraryStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createRegisterLibraryInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createRegisterLibraryInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: true,
...
var registerOAppParamsBeet = new beet201__namespace.BeetArgsStruct(
  [["delegate", beetSolana97__namespace.publicKey]],
  "RegisterOAppParams"
);

// src/generated/endpoint/instructions/registerOapp.ts
var registerOappStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createRegisterOappInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createRegisterOappInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.payer,
      isWritable: true,
...
var sendParamsBeet2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["dstEid", beet201__namespace.u32],
    ["receiver", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["message", beet201__namespace.bytes],
...
var sendStruct2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSendInstruction2(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createSendInstructionAccounts2(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.sender,
      isWritable: false,
...
var sendComposeParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["to", beetSolana97__namespace.publicKey],
    ["guid", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["index", beet201__namespace.u16],
...
var sendComposeStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSendComposeInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createSendComposeInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.from,
      isWritable: false,
...
var setConfigParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["oapp", beetSolana97__namespace.publicKey],
    ["eid", beet201__namespace.u32],
    ["configType", beet201__namespace.u32],
    ["config", beet201__namespace.bytes]
  ],
  "SetConfigParams"
);

// src/generated/endpoint/instructions/setConfig.ts
var setConfigStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetConfigInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createSetConfigInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.signer,
      isWritable: false,
...
var setDefaultReceiveLibraryParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["newLib", beetSolana97__namespace.publicKey],
    ["gracePeriod", beet201__namespace.u64]
  ],
  "SetDefaultReceiveLibraryParams"
);

// src/generated/endpoint/instructions/setDefaultReceiveLibrary.ts
var setDefaultReceiveLibraryStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetDefaultReceiveLibraryInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createSetDefaultReceiveLibraryInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var setDefaultReceiveLibraryTimeoutParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["lib", beetSolana97__namespace.publicKey],
    ["expiry", beet201__namespace.u64]
  ],
...
var setDefaultReceiveLibraryTimeoutStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetDefaultReceiveLibraryTimeoutInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createSetDefaultReceiveLibraryTimeoutInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var setDefaultSendLibraryParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["newLib", beetSolana97__namespace.publicKey]
  ],
...
var setDefaultSendLibraryStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetDefaultSendLibraryInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createSetDefaultSendLibraryInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var setDelegateParamsBeet2 = new beet201__namespace.BeetArgsStruct(
  [["delegate", beetSolana97__namespace.publicKey]],
  "SetDelegateParams"
);

// src/generated/endpoint/instructions/setDelegate.ts
var setDelegateStruct2 = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetDelegateInstruction2(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createSetDelegateInstructionAccounts2(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.oapp,
      isWritable: false,
...
var setLzTokenParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [["lzToken", beet201__namespace.coption(beetSolana97__namespace.publicKey)]],
  "SetLzTokenParams"
);

// src/generated/endpoint/instructions/setLzToken.ts
var setLzTokenStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetLzTokenInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createSetLzTokenInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var setReceiveLibraryParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["eid", beet201__namespace.u32],
    ["newLib", beetSolana97__namespace.publicKey],
...
var setReceiveLibraryStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetReceiveLibraryInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createSetReceiveLibraryInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.signer,
      isWritable: false,
...
var setReceiveLibraryTimeoutParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["eid", beet201__namespace.u32],
    ["lib", beetSolana97__namespace.publicKey],
...
var setReceiveLibraryTimeoutStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetReceiveLibraryTimeoutInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createSetReceiveLibraryTimeoutInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.signer,
      isWritable: false,
...
var setSendLibraryParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["sender", beetSolana97__namespace.publicKey],
    ["eid", beet201__namespace.u32],
    ["newLib", beetSolana97__namespace.publicKey]
...
var setSendLibraryStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetSendLibraryInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createSetSendLibraryInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.signer,
      isWritable: false,
...
var skipParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["srcEid", beet201__namespace.u32],
    ["sender", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
...
var skipStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSkipInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createSkipInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.signer,
      isWritable: false,
...
var transferAdminParamsBeet2 = new beet201__namespace.BeetArgsStruct(
  [["admin", beetSolana97__namespace.publicKey]],
  "TransferAdminParams"
);

// src/generated/endpoint/instructions/transferAdmin.ts
var transferAdminStruct2 = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createTransferAdminInstruction2(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createTransferAdminInstructionAccounts2(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var verifyParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["srcEid", beet201__namespace.u32],
    ["sender", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["receiver", beetSolana97__namespace.publicKey],
...
var verifyStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createVerifyInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createVerifyInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.receiveLibrary,
      isWritable: false,
...
var withdrawRentParamsBeet = new beet201__namespace.BeetArgsStruct(
  [["amount", beet201__namespace.u64]],
  "WithdrawRentParams"
);

// src/generated/endpoint/instructions/withdrawRent.ts
var withdrawRentStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createWithdrawRentInstruction(accounts, args, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
...
function createWithdrawRentInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var messagingFeeBeet2 = new beet201__namespace.BeetArgsStruct(
  [
    ["nativeFee", beet201__namespace.u64],
    ["lzTokenFee", beet201__namespace.u64]
  ],
...
var messagingReceiptBeet2 = new beet201__namespace.BeetArgsStruct(
  [
    ["guid", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["nonce", beet201__namespace.u64],
    ["fee", messagingFeeBeet2]
  ],
  "MessagingReceipt"
);

// src/generated/endpoint/index.ts
var PROGRAM_ADDRESS2 = "76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6";
var PROGRAM_ID2 = new web35.PublicKey(PROGRAM_ADDRESS2);
...
var adminTransferredEventBeet = new beet201__namespace.BeetArgsStruct(
  [["newAdmin", beetSolana97__namespace.publicKey]],
  "AdminTransferredEvent"
);
var composeDeliveredEventBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["from", beetSolana97__namespace.publicKey],
    ["to", beetSolana97__namespace.publicKey],
    ["guid", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
...
var composeSentEventBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["from", beetSolana97__namespace.publicKey],
    ["to", beetSolana97__namespace.publicKey],
    ["guid", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
...
var defaultReceiveLibrarySetEventBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["newLib", beetSolana97__namespace.publicKey]
  ],
...
var defaultReceiveLibraryTimeoutSetEventBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["timeout", beet201__namespace.coption(receiveLibraryTimeoutBeet)]
  ],
...
var defaultSendLibrarySetEventBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["newLib", beetSolana97__namespace.publicKey]
  ],
...
var delegateSetEventBeet = new beet201__namespace.BeetArgsStruct(
  [["newDelegate", beetSolana97__namespace.publicKey]],
  "DelegateSetEvent"
);
var inboundNonceSkippedEventBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["srcEid", beet201__namespace.u32],
    ["sender", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["receiver", beetSolana97__namespace.publicKey],
...
var libraryRegisteredEventBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["newLib", beetSolana97__namespace.publicKey],
    ["newLibProgram", beetSolana97__namespace.publicKey]
  ],
  "LibraryRegisteredEvent"
);
var lzComposeAlertEventBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["executor", beetSolana97__namespace.publicKey],
    ["from", beetSolana97__namespace.publicKey],
    ["to", beetSolana97__namespace.publicKey],
    ["guid", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["index", beet201__namespace.u16],
...
var lzReceiveAlertEventBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["executor", beetSolana97__namespace.publicKey],
    ["srcEid", beet201__namespace.u32],
...
var lzTokenSetEventBeet = new beet201__namespace.FixableBeetArgsStruct(
  [["token", beet201__namespace.coption(beetSolana97__namespace.publicKey)]],
  "LzTokenSetEvent"
);
var oAppRegisteredEventBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["oapp", beetSolana97__namespace.publicKey],
    ["delegate", beetSolana97__namespace.publicKey]
  ],
...
var packetBurntEventBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["srcEid", beet201__namespace.u32],
    ["sender", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["receiver", beetSolana97__namespace.publicKey],
...
var packetDeliveredEventBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["srcEid", beet201__namespace.u32],
    ["sender", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["receiver", beetSolana97__namespace.publicKey],
...
var packetNilifiedEventBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["srcEid", beet201__namespace.u32],
    ["sender", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["receiver", beetSolana97__namespace.publicKey],
...
var packetSentEventBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["encodedPacket", beet201__namespace.bytes],
    ["options", beet201__namespace.bytes],
    ["sendLibrary", beetSolana97__namespace.publicKey]
  ],
  "PacketSentEvent"
);
var packetVerifiedEventBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["srcEid", beet201__namespace.u32],
    ["sender", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["receiver", beetSolana97__namespace.publicKey],
...
var receiveLibrarySetEventBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["eid", beet201__namespace.u32],
    ["newLib", beetSolana97__namespace.publicKey]
...
var receiveLibraryTimeoutSetEventBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["eid", beet201__namespace.u32],
    ["timeout", beet201__namespace.coption(receiveLibraryTimeoutBeet)]
...
var rentWithdrawnEventBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["amount", beet201__namespace.u64]
  ],
...
var sendLibrarySetEventBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["sender", beetSolana97__namespace.publicKey],
    ["eid", beet201__namespace.u32],
    ["newLib", beetSolana97__namespace.publicKey]
...
var DefaultMessageLib = web35.PublicKey.default;
var Endpoint = class {
  constructor(program) {
    this.program = program;
    this.endpointDeriver = new EndpointPDADeriver(program);
  ...
  async getQuoteIXAccountMetaForCPI(connection, payer, path, msgLibProgram) {
    ...
    const accounts = createQuoteInstructionAccounts2(
      {
        sendLibraryConfig,
  ...
  async getSendIXAccountMetaForCPI(connection, payer, path, msgLibProgram, commitmentOrConfig) {
    ...
    const [sendLibraryConfig] = this.endpointDeriver.sendLibraryConfig(sender, dstEid);
    const [nonce] = this.endpointDeriver.nonce(sender, dstEid, receiver);
    const accounts = createSendInstructionAccounts2(
      {
        sender,
        //signer
    ...
    const ix = createSkipInstruction(
      ...
      },
      {
        params: {
          ...
          nonce: new BN6__default.default(nonce)
        }
      },
      this.program
    );
  ...
  getVerifyIXAccountMetaForCPI(packet, receiveLibrary) {
    const receiver = new web35.PublicKey(Buffer.from(packet.receiver().slice(2), "hex"));
  ...
  async getSendLibrary(connection, oappPda, dstEid, commitmentOrConfig) {
    ...
    const [info] = SendLibraryConfig.fromAccountInfo(accountInfo, 0);
    if (info.messageLib.toString() == DefaultMessageLib.toString()) {
      return this.getDefaultSendLibrary(connection, dstEid, commitmentOrConfig).then((info2) => {
        if (!info2) {
          throw new Error("default send library not initialized");
        }
        return {
          programId: info2.owner,
          msgLib: info2.msgLib,
          isDefault: true
        };
      });
  ...
  async getReceiveLibrary(connection, oappPda, srcEid, commitmentOrConfig) {
    ...
    if (info.messageLib.toString() == DefaultMessageLib.toString()) {
      ...
      if (messageLibInfo2) {
        ...
        if (timeout2) {
          ...
          invariant2__default.default(timestamp, "timestamp should not be null");
    ...
    invariant2__default.default(messageLibInfo, "messageLibInfo should not be null");
    const { timeout } = info;
    if (timeout) {
      const slot = await connection.getSlot();
      const timestamp = await connection.getBlockTime(slot);
  ...
  async getNonce(connection, oappIDPDA2, remoteEid, remoteOappAddr, commitmentOrConfig) {
    const [nonce] = this.endpointDeriver.nonce(oappIDPDA2, remoteEid, remoteOappAddr);
    try {
  ...
  async transferAdmin(connection, admin, newAdmin, commitment = "confirmed") {
    ...
    return createTransferAdminInstruction2(
      {
        admin,
        endpoint: settingPDA,
        eventAuthority: this.eventAuthorityPDA,
...
var MessageLib = class _MessageLib {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, messageLibBeet);
  }
  /**
...
var messageLibBeet = new beet201__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["eid", beet201__namespace.u32],
    ["endpoint", beetSolana97__namespace.publicKey],
    ["endpointProgram", beetSolana97__namespace.publicKey],
    ["bump", beet201__namespace.u8],
    ["admin", beetSolana97__namespace.publicKey],
    ["fee", beet201__namespace.u64],
    ["lzTokenFee", beet201__namespace.u64],
    ["wlCaller", beetSolana97__namespace.publicKey]
  ],
  MessageLib.fromArgs,
  "MessageLib"
);
...
var ReceiveConfigStore = class _ReceiveConfigStore {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, receiveConfigStoreBeet);
  }
  /**
...
var receiveConfigStoreBeet = new beet201__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["bump", beet201__namespace.u8],
    ["data", beet201__namespace.bytes]
  ],
...
var SendConfigStore = class _SendConfigStore {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, sendConfigStoreBeet);
  }
  /**
...
var sendConfigStoreBeet = new beet201__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["bump", beet201__namespace.u8],
    ["data", beet201__namespace.bytes]
...
createErrorFromCodeLookup3.set(6e3, () => new OnlyWhitelistedCallerError());
...
createErrorFromCodeLookup3.set(6001, () => new InsufficientFeeError());
createErrorFromNameLookup3.set(
  "InsufficientFee",
...
createErrorFromCodeLookup3.set(6002, () => new InvalidAmountError2());
createErrorFromNameLookup3.set("InvalidAmount", () => new InvalidAmountError2());
...
createErrorFromCodeLookup3.set(6003, () => new InvalidConfigTypeError());
createErrorFromNameLookup3.set(
  "InvalidConfigType",
...
createErrorFromCodeLookup3.set(6004, () => new InvalidLzTokenMintError());
createErrorFromNameLookup3.set(
  "InvalidLzTokenMint",
...
createErrorFromCodeLookup3.set(6005, () => new LzTokenUnavailableError2());
createErrorFromNameLookup3.set(
  "LzTokenUnavailable",
...
createErrorFromCodeLookup3.set(6006, () => new SendReentrancyError());
createErrorFromNameLookup3.set("SendReentrancy", () => new SendReentrancyError());
...
var initConfigParamsBeet2 = new beet201__namespace.BeetArgsStruct(
  [
    ["oapp", beetSolana97__namespace.publicKey],
    ["eid", beet201__namespace.u32]
  ],
...
var initConfigStruct2 = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitConfigInstruction2(accounts, args, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
...
function createInitConfigInstructionAccounts2(accounts, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
  const keys = [
    {
      pubkey: accounts.endpoint,
      isWritable: false,
...
var initDefaultConfigParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["sendConfig", beet201__namespace.coption(beet201__namespace.bytes)],
    ["receiveConfig", beet201__namespace.coption(beet201__namespace.bytes)]
  ],
  "InitDefaultConfigParams"
);

// src/generated/simple_messagelib/instructions/initDefaultConfig.ts
var initDefaultConfigStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitDefaultConfigInstruction(accounts, args, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
...
function createInitDefaultConfigInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: true,
...
var initMessageLibParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["endpoint", beetSolana97__namespace.publicKey],
    ["endpointProgram", beetSolana97__namespace.publicKey],
...
var initMessageLibStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitMessageLibInstruction(accounts, args, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
...
function createInitMessageLibInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
  const keys = [
    {
      pubkey: accounts.payer,
      isWritable: true,
...
var packetBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["nonce", beet201__namespace.u64],
    ["srcEid", beet201__namespace.u32],
    ["sender", beetSolana97__namespace.publicKey],
...
var quoteParamsBeet3 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["packet", packetBeet],
    ["options", beet201__namespace.bytes],
    ["payInLzToken", beet201__namespace.bool]
...
var quoteStruct3 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createQuoteInstruction3(accounts, args, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
...
function createQuoteInstructionAccounts3(accounts, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
  const keys = [
    {
      pubkey: accounts.endpoint,
      isWritable: false,
...
var revertCallStruct = new beet201__namespace.BeetArgsStruct(
  [["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)]],
...
function createRevertCallInstruction(programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
...
function createRevertCallInstructionAccounts(programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
  const keys = [];
  return keys;
}
var sendParamsBeet3 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["packet", packetBeet],
    ["options", beet201__namespace.bytes],
    ["nativeFee", beet201__namespace.u64]
...
var sendStruct3 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSendInstruction3(accounts, args, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
...
function createSendInstructionAccounts3(accounts, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
  const keys = [
    {
      pubkey: accounts.endpoint,
      isWritable: false,
...
var sendWithLzTokenParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["packet", packetBeet],
    ["options", beet201__namespace.bytes],
    ["nativeFee", beet201__namespace.u64],
    ["lzTokenFee", beet201__namespace.u64],
    ["lzTokenMint", beetSolana97__namespace.publicKey]
  ],
  "SendWithLzTokenParams"
);

// src/generated/simple_messagelib/instructions/sendWithLzToken.ts
var sendWithLzTokenStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSendWithLzTokenInstruction(accounts, args, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
...
function createSendWithLzTokenInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
  const keys = [
    {
      pubkey: accounts.endpoint,
      isWritable: false,
...
var setConfigParamsBeet2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["oapp", beetSolana97__namespace.publicKey],
    ["eid", beet201__namespace.u32],
    ["configType", beet201__namespace.u32],
...
var setConfigStruct2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetConfigInstruction2(accounts, args, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
...
function createSetConfigInstructionAccounts2(accounts, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
  const keys = [
    {
      pubkey: accounts.endpoint,
      isWritable: false,
...
var setDefaultConfigParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["sendConfig", beet201__namespace.coption(beet201__namespace.bytes)],
    ["receiveConfig", beet201__namespace.coption(beet201__namespace.bytes)]
...
var setDefaultConfigStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetDefaultConfigInstruction(accounts, args, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
...
function createSetDefaultConfigInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var setFeeParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["fee", beet201__namespace.u64],
    ["lzTokenFee", beet201__namespace.u64]
  ],
...
var setFeeStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetFeeInstruction(accounts, args, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
...
function createSetFeeInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var setWlCallerParamsBeet = new beet201__namespace.BeetArgsStruct(
  [["newCaller", beetSolana97__namespace.publicKey]],
  "SetWlCallerParams"
);

// src/generated/simple_messagelib/instructions/setWlCaller.ts
var setWlCallerStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetWlCallerInstruction(accounts, args, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
...
function createSetWlCallerInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var transferAdminParamsBeet3 = new beet201__namespace.BeetArgsStruct(
  [["admin", beetSolana97__namespace.publicKey]],
  "TransferAdminParams"
);

// src/generated/simple_messagelib/instructions/transferAdmin.ts
var transferAdminStruct3 = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createTransferAdminInstruction3(accounts, args, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
...
function createTransferAdminInstructionAccounts3(accounts, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var validatePacketParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [["packet", beet201__namespace.bytes]],
  "ValidatePacketParams"
);

// src/generated/simple_messagelib/instructions/validatePacket.ts
var validatePacketStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createValidatePacketInstruction(accounts, args, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
...
function createValidatePacketInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
  const keys = [
    {
      pubkey: accounts.payer,
      isWritable: false,
...
var versionStruct2 = new beet201__namespace.BeetArgsStruct(
  [["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)]],
  "VersionInstructionArgs"
);
...
function createVersionInstruction2(programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
...
function createVersionInstructionAccounts2(programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
  const keys = [];
  return keys;
}
var withdrawFeesParamsBeet = new beet201__namespace.BeetArgsStruct(
  [["amount", beet201__namespace.u64]],
  "WithdrawFeesParams"
);

// src/generated/simple_messagelib/instructions/withdrawFees.ts
var withdrawFeesStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createWithdrawFeesInstruction(accounts, args, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
...
function createWithdrawFeesInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var messagingFeeBeet3 = new beet201__namespace.BeetArgsStruct(
  [
    ["nativeFee", beet201__namespace.u64],
    ["lzTokenFee", beet201__namespace.u64]
  ],
...
var versionBeet2 = new beet201__namespace.BeetArgsStruct(
  [
    ["major", beet201__namespace.u64],
    ["minor", beet201__namespace.u8],
    ["endpointVersion", beet201__namespace.u8]
  ],
  "Version"
);
var PROGRAM_ADDRESS3 = "6GsmxMTHAAiFKfemuM4zBjumTjNSX5CAiw4xSSXM2Toy";
var PROGRAM_ID3 = new web35.PublicKey(PROGRAM_ADDRESS3);
...
var multisigBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["signers", beet201__namespace.array(beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 64))],
    ["quorum", beet201__namespace.u8]
  ],
  "Multisig"
);
var aclBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["allowList", beet201__namespace.array(beetSolana97__namespace.publicKey)],
    ["denyList", beet201__namespace.array(beetSolana97__namespace.publicKey)]
  ],
  "Acl"
);
var dstConfigBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["dstGas", beet201__namespace.u32],
    ["multiplierBps", beet201__namespace.coption(beet201__namespace.u16)],
    ["floorMarginUsd", beet201__namespace.coption(beet201__namespace.u128)]
  ],
  "DstConfig"
);
...
var DvnConfig = class _DvnConfig {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, dvnConfigBeet);
  }
  /**
...
var dvnConfigBeet = new beet201__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["vid", beet201__namespace.u32],
    ["bump", beet201__namespace.u8],
    ["multisig", multisigBeet],
    ["acl", aclBeet],
    ["paused", beet201__namespace.bool],
    ["msglibs", beet201__namespace.array(beetSolana97__namespace.publicKey)],
    ["admins", beet201__namespace.array(beetSolana97__namespace.publicKey)],
    ["priceFeed", beetSolana97__namespace.publicKey],
    ["dstConfigs", beet201__namespace.array(dstConfigBeet)],
    ["defaultMultiplierBps", beet201__namespace.u16]
  ],
  DvnConfig.fromArgs,
  "DvnConfig"
);
...
var ExecuteHash = class _ExecuteHash {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, executeHashBeet);
  }
  /**
...
var executeHashBeet = new beet201__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["expiration", beet201__namespace.i64],
    ["bump", beet201__namespace.u8]
  ],
  ExecuteHash.fromArgs,
  "ExecuteHash"
);
var ulnConfigBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["confirmations", beet201__namespace.u64],
    ["requiredDvnCount", beet201__namespace.u8],
    ["optionalDvnCount", beet201__namespace.u8],
    ["optionalDvnThreshold", beet201__namespace.u8],
    ["requiredDvns", beet201__namespace.array(beetSolana97__namespace.publicKey)],
    ["optionalDvns", beet201__namespace.array(beetSolana97__namespace.publicKey)]
  ],
  "UlnConfig"
);
...
var ReceiveConfig = class _ReceiveConfig {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, receiveConfigBeet);
  }
  /**
...
var receiveConfigBeet = new beet201__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["bump", beet201__namespace.u8],
    ["uln", ulnConfigBeet]
...
// src/generated/dvn/accounts/index.ts
var accountProviders4 = { DvnConfig, ExecuteHash, ReceiveConfig };
...
createErrorFromCodeLookup4.set(6e3, () => new InvalidSignatureLenError());
...
createErrorFromCodeLookup4.set(6001, () => new NotAdminError());
createErrorFromNameLookup4.set("NotAdmin", () => new NotAdminError());
...
createErrorFromCodeLookup4.set(6002, () => new MsgLibNotAllowedError());
createErrorFromNameLookup4.set(
  "MsgLibNotAllowed",
...
createErrorFromCodeLookup4.set(6003, () => new InvalidQuorumError());
createErrorFromNameLookup4.set("InvalidQuorum", () => new InvalidQuorumError());
...
createErrorFromCodeLookup4.set(6004, () => new InvalidSignersLenError());
createErrorFromNameLookup4.set(
  "InvalidSignersLen",
...
createErrorFromCodeLookup4.set(6005, () => new UniqueOwnersError());
createErrorFromNameLookup4.set("UniqueOwners", () => new UniqueOwnersError());
...
createErrorFromCodeLookup4.set(6006, () => new SignatureErrorError());
createErrorFromNameLookup4.set("SignatureError", () => new SignatureErrorError());
...
createErrorFromCodeLookup4.set(6007, () => new SignerNotInCommitteeError());
createErrorFromNameLookup4.set(
...
createErrorFromCodeLookup4.set(6008, () => new TooManyAdminsError());
createErrorFromNameLookup4.set("TooManyAdmins", () => new TooManyAdminsError());
...
createErrorFromCodeLookup4.set(6009, () => new TooManyOptionTypesError());
createErrorFromNameLookup4.set(
  "TooManyOptionTypes",
...
createErrorFromCodeLookup4.set(6010, () => new DuplicateSignatureError());
createErrorFromNameLookup4.set(
  "DuplicateSignature",
...
createErrorFromCodeLookup4.set(6011, () => new ExpiredError());
createErrorFromNameLookup4.set("Expired", () => new ExpiredError());
...
createErrorFromCodeLookup4.set(6012, () => new InvalidVidError());
createErrorFromNameLookup4.set("InvalidVid", () => new InvalidVidError());
...
createErrorFromCodeLookup4.set(6013, () => new PausedError());
createErrorFromNameLookup4.set("Paused", () => new PausedError());
...
createErrorFromCodeLookup4.set(6014, () => new UnexpiredExecuteHashError());
createErrorFromNameLookup4.set(
...
createErrorFromCodeLookup4.set(6015, () => new InvalidAmountError3());
createErrorFromNameLookup4.set("InvalidAmount", () => new InvalidAmountError3());
...
createErrorFromCodeLookup4.set(6016, () => new EidNotSupportedError());
createErrorFromNameLookup4.set(
  "EidNotSupported",
...
var closeExecuteParamsBeet = new beet201__namespace.BeetArgsStruct(
  [["digestHash", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)]],
  "CloseExecuteParams"
);

// src/generated/dvn/instructions/closeExecute.ts
var closeExecuteStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createCloseExecuteInstruction(accounts, args, programId = new web35__namespace.PublicKey("HtEYV4xB4wvsj5fgTkcfuChYpvGYzgzwvNhgDZQNh7wW")) {
...
function createCloseExecuteInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HtEYV4xB4wvsj5fgTkcfuChYpvGYzgzwvNhgDZQNh7wW")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var initDvnParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["vid", beet201__namespace.u32],
    ["msglibs", beet201__namespace.array(beetSolana97__namespace.publicKey)],
    ["priceFeed", beetSolana97__namespace.publicKey],
...
var initDvnStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitDvnInstruction(accounts, args, programId = new web35__namespace.PublicKey("HtEYV4xB4wvsj5fgTkcfuChYpvGYzgzwvNhgDZQNh7wW")) {
...
function createInitDvnInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HtEYV4xB4wvsj5fgTkcfuChYpvGYzgzwvNhgDZQNh7wW")) {
  const keys = [
    {
      pubkey: accounts.payer,
      isWritable: true,
...
var transactionAccountBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["pubkey", beetSolana97__namespace.publicKey],
    ["isSigner", beet201__namespace.bool],
    ["isWritable", beet201__namespace.bool]
...
var executeTransactionDigestBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["vid", beet201__namespace.u32],
    ["programId", beetSolana97__namespace.publicKey],
    ["accounts", beet201__namespace.array(transactionAccountBeet)],
    ["data", beet201__namespace.bytes],
    ["expiration", beet201__namespace.i64]
  ],
...
var invokeParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["digest", executeTransactionDigestBeet],
    ["signatures", beet201__namespace.array(beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 65))]
  ],
  "InvokeParams"
);

// src/generated/dvn/instructions/invoke.ts
var invokeStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInvokeInstruction(accounts, args, programId = new web35__namespace.PublicKey("HtEYV4xB4wvsj5fgTkcfuChYpvGYzgzwvNhgDZQNh7wW")) {
...
function createInvokeInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HtEYV4xB4wvsj5fgTkcfuChYpvGYzgzwvNhgDZQNh7wW")) {
  const keys = [
    {
      pubkey: accounts.signer,
      isWritable: true,
...
var lzOptionBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["optionType", beet201__namespace.u8],
    ["params", beet201__namespace.bytes]
  ],
  "LzOption"
);

// src/generated/dvn/types/QuoteDvnParams.ts
var quoteDvnParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["msglib", beetSolana97__namespace.publicKey],
    ["dstEid", beet201__namespace.u32],
    ["sender", beetSolana97__namespace.publicKey],
    ["packetHeader", beet201__namespace.bytes],
    ["payloadHash", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["confirmations", beet201__namespace.u64],
    ["options", beet201__namespace.array(lzOptionBeet)]
  ],
  "QuoteDvnParams"
);

// src/generated/dvn/instructions/quoteDvn.ts
var quoteDvnStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createQuoteDvnInstruction(accounts, args, programId = new web35__namespace.PublicKey("HtEYV4xB4wvsj5fgTkcfuChYpvGYzgzwvNhgDZQNh7wW")) {
...
function createQuoteDvnInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HtEYV4xB4wvsj5fgTkcfuChYpvGYzgzwvNhgDZQNh7wW")) {
  const keys = [
    {
      pubkey: accounts.dvnConfig,
      isWritable: false,
...
var adminConfigBeet = beet201__namespace.dataEnum([
  [
    "Admins",
    new beet201__namespace.FixableBeetArgsStruct(
      [["fields", beet201__namespace.tuple([beet201__namespace.array(beetSolana97__namespace.publicKey)])]],
  ...
  [
    ...
    new beet201__namespace.BeetArgsStruct(
      [["fields", beet201__namespace.fixedSizeTuple([beet201__namespace.u16])]],
  ...
  [
    "DstConfigs",
    new beet201__namespace.FixableBeetArgsStruct(
      [["fields", beet201__namespace.tuple([beet201__namespace.array(dstConfigBeet)])]],
...
var setConfigParamsBeet3 = new beet201__namespace.FixableBeetArgsStruct(
  [["config", adminConfigBeet]],
  "SetConfigParams"
);

// src/generated/dvn/instructions/setConfig.ts
var setConfigStruct3 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetConfigInstruction3(accounts, args, programId = new web35__namespace.PublicKey("HtEYV4xB4wvsj5fgTkcfuChYpvGYzgzwvNhgDZQNh7wW")) {
...
function createSetConfigInstructionAccounts3(accounts, programId = new web35__namespace.PublicKey("HtEYV4xB4wvsj5fgTkcfuChYpvGYzgzwvNhgDZQNh7wW")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var verifiableParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
...
var verifiableStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createVerifiableInstruction(accounts, args, programId = new web35__namespace.PublicKey("HtEYV4xB4wvsj5fgTkcfuChYpvGYzgzwvNhgDZQNh7wW")) {
...
function createVerifiableInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HtEYV4xB4wvsj5fgTkcfuChYpvGYzgzwvNhgDZQNh7wW")) {
  const keys = [
    {
      pubkey: accounts.nonce,
      isWritable: false,
...
var withdrawFeeParamsBeet = new beet201__namespace.BeetArgsStruct(
  [["amount", beet201__namespace.u64]],
  "WithdrawFeeParams"
);

// src/generated/dvn/instructions/withdrawFee.ts
var withdrawFeeStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createWithdrawFeeInstruction(accounts, args, programId = new web35__namespace.PublicKey("HtEYV4xB4wvsj5fgTkcfuChYpvGYzgzwvNhgDZQNh7wW")) {
...
function createWithdrawFeeInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("HtEYV4xB4wvsj5fgTkcfuChYpvGYzgzwvNhgDZQNh7wW")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var multisigConfigBeet = beet201__namespace.dataEnum([
  [
    "Admins",
    new beet201__namespace.FixableBeetArgsStruct(
      [["fields", beet201__namespace.tuple([beet201__namespace.array(beetSolana97__namespace.publicKey)])]],
  ...
  [
    "Paused",
    new beet201__namespace.BeetArgsStruct(
      [["fields", beet201__namespace.fixedSizeTuple([beet201__namespace.bool])]],
  ...
  [
    "Quorum",
    new beet201__namespace.BeetArgsStruct(
      [["fields", beet201__namespace.fixedSizeTuple([beet201__namespace.u8])]],
  ...
  [
    ...
    new beet201__namespace.FixableBeetArgsStruct(
      [
        [
          "fields",
          beet201__namespace.tuple([beet201__namespace.array(beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 64))])
        ]
      ],
...
var verificationStateBeet = beet201__namespace.fixedScalarEnum(
  VerificationState
);

// src/generated/dvn/index.ts
var PROGRAM_ADDRESS4 = "HtEYV4xB4wvsj5fgTkcfuChYpvGYzgzwvNhgDZQNh7wW";
var PROGRAM_ID4 = new web35.PublicKey(PROGRAM_ADDRESS4);
...
var adminConfigSetEventBeet = new beet201__namespace.FixableBeetArgsStruct(
  [["config", adminConfigBeet]],
  "AdminConfigSetEvent"
);
var feeWithdrawnEventBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["amount", beet201__namespace.u64]
  ],
...
var multisigConfigSetEventBeet = new beet201__namespace.FixableBeetArgsStruct(
...
var DVN = class {
  ...
  createSetQuorumInstruction(quorum) {
    ...
    return new web35.TransactionInstruction({
  ...
  async getQuoteIXAccountMetaForCPI(connection, payment, commitment) {
    const [config] = this.dvnDeriver.config();
    const configState = await DvnConfig.fromAccountAddress(connection, config, commitment);
    ...
    const ix = createQuoteDvnInstruction(
      ...
      {
        params: {
          msglib: web35.PublicKey.default,
          dstEid: 0,
          sender: web35.PublicKey.default,
...
var aclBeet2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["allowList", beet201__namespace.array(beetSolana97__namespace.publicKey)],
    ["denyList", beet201__namespace.array(beetSolana97__namespace.publicKey)]
  ],
...
var dstConfigBeet2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["lzReceiveBaseGas", beet201__namespace.u32],
    ["lzComposeBaseGas", beet201__namespace.u32],
    ["multiplierBps", beet201__namespace.coption(beet201__namespace.u16)],
    ["floorMarginUsd", beet201__namespace.coption(beet201__namespace.u128)],
    ["nativeDropCap", beet201__namespace.u128]
  ],
  "DstConfig"
);
...
var ExecutorConfig = class _ExecutorConfig {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, executorConfigBeet);
  }
  /**
...
var executorConfigBeet = new beet201__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["bump", beet201__namespace.u8],
    ["owner", beetSolana97__namespace.publicKey],
    ["acl", aclBeet2],
    ["admins", beet201__namespace.array(beetSolana97__namespace.publicKey)],
    ["executors", beet201__namespace.array(beetSolana97__namespace.publicKey)],
    ["msglibs", beet201__namespace.array(beetSolana97__namespace.publicKey)],
    ["paused", beet201__namespace.bool],
    ["defaultMultiplierBps", beet201__namespace.u16],
    ["priceFeed", beetSolana97__namespace.publicKey],
    ["dstConfigs", beet201__namespace.array(dstConfigBeet2)]
  ],
...
var Nonce2 = class _Nonce {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, nonceBeet2);
  }
  /**
   * Deserializes the {@link Nonce} from the provided data Buffer.
   * @returns a tuple of the account data and the offset up to which the buffer was read to obtain it.
...
var nonceBeet2 = new beet201__namespace.BeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["bump", beet201__namespace.u8],
    ["outboundNonce", beet201__namespace.u64],
...
// src/generated/executor/accounts/index.ts
var accountProviders5 = { Nonce: Nonce2, ExecutorConfig };
...
var nativeDropRequestBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["amount", beet201__namespace.u64]
  ],
...
var nativeDropAppliedEventBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["srcEid", beet201__namespace.u32],
    ["sender", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["nonce", beet201__namespace.u64],
    ["dstEid", beet201__namespace.u32],
    ["oapp", beetSolana97__namespace.publicKey],
    ["nativeDropRequests", beet201__namespace.array(nativeDropRequestBeet)],
    ["successes", beet201__namespace.array(beet201__namespace.bool)]
  ],
...
var adminSetConfigParamsBeet = beet201__namespace.dataEnum([
  [
    "PriceFeed",
    new beet201__namespace.BeetArgsStruct(
      [["fields", beet201__namespace.fixedSizeTuple([beetSolana97__namespace.publicKey])]],
  ...
  [
    "DstConfigs",
    new beet201__namespace.FixableBeetArgsStruct(
      [["fields", beet201__namespace.tuple([beet201__namespace.array(dstConfigBeet2)])]],
...
var adminSetConfigStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createAdminSetConfigInstruction(accounts, args, programId = new web35__namespace.PublicKey("6doghB248px58JSSwG4qejQ46kFMW4AMj7vzJnWZHNZn")) {
...
function createAdminSetConfigInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("6doghB248px58JSSwG4qejQ46kFMW4AMj7vzJnWZHNZn")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var lzComposeParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["from", beetSolana97__namespace.publicKey],
    ["to", beetSolana97__namespace.publicKey],
    ["guid", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
...
var composeParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
...
var composeStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createComposeInstruction(accounts, args, programId = new web35__namespace.PublicKey("6doghB248px58JSSwG4qejQ46kFMW4AMj7vzJnWZHNZn")) {
...
function createComposeInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("6doghB248px58JSSwG4qejQ46kFMW4AMj7vzJnWZHNZn")) {
  const keys = [
    {
      pubkey: accounts.executor,
      isWritable: true,
...
var executableParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["srcEid", beet201__namespace.u32],
    ["sender", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
...
var executableStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createExecutableInstruction(accounts, args, programId = new web35__namespace.PublicKey("6doghB248px58JSSwG4qejQ46kFMW4AMj7vzJnWZHNZn")) {
...
function createExecutableInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("6doghB248px58JSSwG4qejQ46kFMW4AMj7vzJnWZHNZn")) {
  const keys = [
    {
      pubkey: accounts.nonce,
      isWritable: false,
...
var lzReceiveParamsBeet2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["srcEid", beet201__namespace.u32],
    ["sender", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["nonce", beet201__namespace.u64],
...
var executeParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["lzReceive", lzReceiveParamsBeet2],
    ["value", beet201__namespace.u64],
    ["computeUnits", beet201__namespace.u64]
  ],
  "ExecuteParams"
...
var executeStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createExecuteInstruction(accounts, args, programId = new web35__namespace.PublicKey("6doghB248px58JSSwG4qejQ46kFMW4AMj7vzJnWZHNZn")) {
...
function createExecuteInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("6doghB248px58JSSwG4qejQ46kFMW4AMj7vzJnWZHNZn")) {
  const keys = [
    {
      pubkey: accounts.executor,
      isWritable: true,
...
var initExecutorParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["owner", beetSolana97__namespace.publicKey],
    ["admins", beet201__namespace.array(beetSolana97__namespace.publicKey)],
    ["executors", beet201__namespace.array(beetSolana97__namespace.publicKey)],
...
var initExecutorStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitExecutorInstruction(accounts, args, programId = new web35__namespace.PublicKey("6doghB248px58JSSwG4qejQ46kFMW4AMj7vzJnWZHNZn")) {
...
function createInitExecutorInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("6doghB248px58JSSwG4qejQ46kFMW4AMj7vzJnWZHNZn")) {
  const keys = [
    {
      pubkey: accounts.payer,
      isWritable: true,
...
var nativeDropParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["srcEid", beet201__namespace.u32],
    ["sender", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["nonce", beet201__namespace.u64],
...
var nativeDropStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createNativeDropInstruction(accounts, args, programId = new web35__namespace.PublicKey("6doghB248px58JSSwG4qejQ46kFMW4AMj7vzJnWZHNZn")) {
...
function createNativeDropInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("6doghB248px58JSSwG4qejQ46kFMW4AMj7vzJnWZHNZn")) {
  const keys = [
    {
      pubkey: accounts.executor,
      isWritable: true,
...
var ownerSetConfigParamsBeet = beet201__namespace.dataEnum([
  [
    "Admins",
    new beet201__namespace.FixableBeetArgsStruct(
      [["fields", beet201__namespace.tuple([beet201__namespace.array(beetSolana97__namespace.publicKey)])]],
...
var ownerSetConfigStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createOwnerSetConfigInstruction(accounts, args, programId = new web35__namespace.PublicKey("6doghB248px58JSSwG4qejQ46kFMW4AMj7vzJnWZHNZn")) {
...
function createOwnerSetConfigInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("6doghB248px58JSSwG4qejQ46kFMW4AMj7vzJnWZHNZn")) {
  const keys = [
    {
      pubkey: accounts.owner,
      isWritable: false,
...
var lzOptionBeet2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["optionType", beet201__namespace.u8],
    ["params", beet201__namespace.bytes]
  ],
...
var quoteExecutorParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["msglib", beetSolana97__namespace.publicKey],
    ["dstEid", beet201__namespace.u32],
    ["sender", beetSolana97__namespace.publicKey],
    ["calldataSize", beet201__namespace.u64],
    ["options", beet201__namespace.array(lzOptionBeet2)]
  ],
  "QuoteExecutorParams"
);

// src/generated/executor/instructions/quoteExecutor.ts
var quoteExecutorStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createQuoteExecutorInstruction(accounts, args, programId = new web35__namespace.PublicKey("6doghB248px58JSSwG4qejQ46kFMW4AMj7vzJnWZHNZn")) {
...
function createQuoteExecutorInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("6doghB248px58JSSwG4qejQ46kFMW4AMj7vzJnWZHNZn")) {
  const keys = [
    {
      pubkey: accounts.executorConfig,
      isWritable: false,
...
var executionStateBeet = beet201__namespace.fixedScalarEnum(
  ExecutionState
);
...
var adminTransferredEventBeet2 = new beet201__namespace.BeetArgsStruct(
  [["newAdmin", beetSolana97__namespace.publicKey]],
  "AdminTransferredEvent"
);
var ulnConfigBeet2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["confirmations", beet201__namespace.u64],
    ["requiredDvnCount", beet201__namespace.u8],
    ["optionalDvnCount", beet201__namespace.u8],
...
var executorConfigBeet2 = new beet201__namespace.BeetArgsStruct(
  [
    ["maxMessageSize", beet201__namespace.u32],
    ["executor", beetSolana97__namespace.publicKey]
  ],
  "ExecutorConfig"
);
...
var configBeet = beet201__namespace.dataEnum([
  [
    "SendUln",
    new beet201__namespace.FixableBeetArgsStruct(
      [["fields", beet201__namespace.tuple([ulnConfigBeet2])]],
  ...
  [
    "Executor",
    new beet201__namespace.BeetArgsStruct(
      [["fields", beet201__namespace.fixedSizeTuple([executorConfigBeet2])]],
...
var configSetEventBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["oapp", beetSolana97__namespace.publicKey],
    ["eid", beet201__namespace.u32],
    ["config", configBeet]
...
var defaultConfigSetEventBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["sendUlnConfig", beet201__namespace.coption(ulnConfigBeet2)],
    ["receiveUlnConfig", beet201__namespace.coption(ulnConfigBeet2)],
    ["executorConfig", beet201__namespace.coption(executorConfigBeet2)]
  ],
  "DefaultConfigSetEvent"
);
var workerFeeBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["worker", beetSolana97__namespace.publicKey],
    ["fee", beet201__namespace.u64]
  ],
  "WorkerFee"
);
var treasuryFeeBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["treasury", beetSolana97__namespace.publicKey],
    ["fee", beet201__namespace.u64],
    ["payInLzToken", beet201__namespace.bool]
  ],
  "TreasuryFee"
...
var feesPaidEventBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["executor", workerFeeBeet],
    ["dvns", beet201__namespace.array(workerFeeBeet)],
    ["treasury", beet201__namespace.coption(treasuryFeeBeet)]
  ],
  "FeesPaidEvent"
);
var payloadVerifiedEventBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["dvn", beetSolana97__namespace.publicKey],
    ["header", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 81)],
    ["confirmations", beet201__namespace.u64],
    ["proofHash", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)]
  ],
  "PayloadVerifiedEvent"
);
var rentWithdrawnEventBeet2 = new beet201__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["amount", beet201__namespace.u64]
  ],
...
var lzTokenTreasuryBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["receiver", beetSolana97__namespace.publicKey],
    ["fee", beet201__namespace.u64]
  ],
...
var treasuryBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["admin", beet201__namespace.coption(beetSolana97__namespace.publicKey)],
    ["nativeReceiver", beetSolana97__namespace.publicKey],
    ["nativeFeeBps", beet201__namespace.u64],
    ["lzToken", beet201__namespace.coption(lzTokenTreasuryBeet)]
  ],
  "Treasury"
);

// src/generated/uln/events/TreasurySetEvent.ts
var treasurySetEventBeet = new beet201__namespace.FixableBeetArgsStruct(
  [["treasury", beet201__namespace.coption(treasuryBeet)]],
  "TreasurySetEvent"
);
...
async function generateAddressLookupTable(connection, payer, authority, addresses) {
  ...
  const [createInstruction, lookupTableAddress] = web35.AddressLookupTableProgram.createLookupTable({
    payer,
    authority,
    recentSlot: slot
  });
  const extendInstruction = web35.AddressLookupTableProgram.extendLookupTable({
    payer,
    authority,
...
function deactivateLookupTable(authority, lookupTable) {
  return web35.AddressLookupTableProgram.deactivateLookupTable({
    authority,
    lookupTable
  });
}
function closeLookupTable(recipient, authority, lookupTable) {
  return web35.AddressLookupTableProgram.closeLookupTable({
    authority,
    recipient,
    lookupTable
  });
...
async function createNonceAccountTX(connection, auth, lamportsForRent) {
  const nonceAccount = web35.Keypair.generate();
  const lamports = lamportsForRent ?? await connection.getMinimumBalanceForRentExemption(web35.NONCE_ACCOUNT_LENGTH);
  const tx = new web35.Transaction();
  tx.add(
    ...
    web35.SystemProgram.createAccount({
      ...
      lamports,
      space: web35.NONCE_ACCOUNT_LENGTH,
      programId: web35.SystemProgram.programId
    }),
    // init nonce account
    web35.SystemProgram.nonceInitialize({
...
async function txWithNonce(connection, noncePubkey, instructions, nonceInfo) {
  ...
  if (!nonceInfo) {
    ...
    if (accountInfo) {
      nonceInfo = web35.NonceAccount.fromAccountData(accountInfo.data);
    } else {
      return null;
    }
  }
  tx.add(
    ...
    web35.SystemProgram.nonceAdvance({
      noncePubkey,
...
async function getLzReceiveAccounts(connection, payer, receiver, receiverProgram, params, commitmentOrConfig = "confirmed") {
  const lzReceiveTypesAccounts = await (async () => {
    ...
    if (info) {
      ...
      for (let i = 8; i < len; i += 32) {
        ...
        accounts.push({
          pubkey: new web35.PublicKey(address),
          isSigner: false,
          isWritable: false
        });
      }
  ...
  const [data] = LzReceiveParamsBeet.serialize(params);
  const lzReceiveTypesIx = new web35.TransactionInstruction({
    programId: receiverProgram,
...
async function getLzComposeAccountMeta(connection, payer, to, composerProgram, params, commitmentOrConfig = "confirmed") {
  ...
  const [data] = LzComposeParamsBeet.serialize(params);
  const lzComposeTypesIx = new web35.TransactionInstruction({
...
function retrieveAccountFromSimulatedResp(resp, payer) {
  const result = beet201.array(LzReceiveAccountBeet);
  const fixedBeet = result.toFixedFromData(resp, 0);
  const results = fixedBeet.read(resp, 0);
  return results.map((r) => {
    if (r.pubkey.toBase58() == web35.PublicKey.default.toBase58() && r.isSigner) {
      if (!payer)
...
createErrorFromCodeLookup5.set(6e3, () => new InvalidSizeError());
createErrorFromNameLookup5.set("InvalidSize", () => new InvalidSizeError());
...
createErrorFromCodeLookup5.set(6001, () => new PausedError2());
createErrorFromNameLookup5.set("Paused", () => new PausedError2());
...
createErrorFromCodeLookup5.set(6002, () => new UnsupportedOptionTypeError());
...
createErrorFromCodeLookup5.set(6003, () => new ZeroLzComposeGasProvidedError());
createErrorFromNameLookup5.set(
...
createErrorFromCodeLookup5.set(6004, () => new ZeroLzReceiveGasProvidedError());
createErrorFromNameLookup5.set(
...
createErrorFromCodeLookup5.set(6005, () => new NativeAmountExceedsCapError());
createErrorFromNameLookup5.set(
...
createErrorFromCodeLookup5.set(6006, () => new NotAdminError2());
createErrorFromNameLookup5.set("NotAdmin", () => new NotAdminError2());
...
createErrorFromCodeLookup5.set(6007, () => new NotExecutorError());
createErrorFromNameLookup5.set("NotExecutor", () => new NotExecutorError());
...
createErrorFromCodeLookup5.set(6008, () => new MsgLibNotAllowedError2());
createErrorFromNameLookup5.set(
  "MsgLibNotAllowed",
...
createErrorFromCodeLookup5.set(6009, () => new TooManyAdminsError2());
createErrorFromNameLookup5.set("TooManyAdmins", () => new TooManyAdminsError2());
...
createErrorFromCodeLookup5.set(6010, () => new TooManyExecutorsError());
createErrorFromNameLookup5.set(
  "TooManyExecutors",
...
createErrorFromCodeLookup5.set(6011, () => new TooManyOptionTypesError2());
createErrorFromNameLookup5.set(
  "TooManyOptionTypes",
...
createErrorFromCodeLookup5.set(6014, () => new InsufficientBalanceError());
createErrorFromNameLookup5.set(
  "InsufficientBalance",
...
createErrorFromCodeLookup5.set(6015, () => new EidNotSupportedError2());
createErrorFromNameLookup5.set(
  "EidNotSupported",
...
createErrorFromCodeLookup5.set(6016, () => new ExecutorIsAdminError());
createErrorFromNameLookup5.set(
  "ExecutorIsAdmin",
...
var PROGRAM_ADDRESS5 = "6doghB248px58JSSwG4qejQ46kFMW4AMj7vzJnWZHNZn";
var PROGRAM_ID5 = new web35.PublicKey(PROGRAM_ADDRESS5);
...
var Executor = class {
  ...
  async getQuoteIXAccountMetaForCPI(connection, payment, commitment) {
    ...
    const configState = await ExecutorConfig.fromAccountAddress(connection, config, commitment);
    const priceFeedConfig = configState.priceFeed;
    const priceFeedConfigState = await connection.getAccountInfo(priceFeedConfig);
    if (!priceFeedConfigState) {
  ...
  async execute(connection, executor, endpointProgram, packet, extraData, value = new BN6__default.default(0), computeUnits = 2e5, commitmentOrConfig) {
    const [config] = this.deriver.config();
  ...
  async compose(connection, executor, endpointProgram, event, extraData, value = new BN6__default.default(0), computeUnits = 4e5, commitmentOrConfig) {
    const [config] = this.deriver.config();
    const endpointEventDeriver = new EventPDADeriver(endpointProgram);
    const executorEventDeriver = new EventPDADeriver(this.program);
    const { to, from, guid, index, message } = event;
...
var Confirmations = class _Confirmations {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, confirmationsBeet);
  }
  /**
...
var confirmationsBeet = new beet201__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["value", beet201__namespace.coption(beet201__namespace.u64)],
    ["bump", beet201__namespace.u8]
  ],
...
var ReceiveConfig2 = class _ReceiveConfig {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, receiveConfigBeet2);
  }
  /**
   * Deserializes the {@link ReceiveConfig} from the provided data Buffer.
   * @returns a tuple of the account data and the offset up to which the buffer was read to obtain it.
...
var receiveConfigBeet2 = new beet201__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["bump", beet201__namespace.u8],
    ["uln", ulnConfigBeet2]
...
var SendConfig = class _SendConfig {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, sendConfigBeet);
  }
  /**
...
var sendConfigBeet = new beet201__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["bump", beet201__namespace.u8],
    ["uln", ulnConfigBeet2],
...
var UlnSettings = class _UlnSettings {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, ulnSettingsBeet);
  }
  /**
...
var ulnSettingsBeet = new beet201__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["eid", beet201__namespace.u32],
    ["endpoint", beetSolana97__namespace.publicKey],
...
var UnauthorizedError3 = class _UnauthorizedError extends Error {
  constructor() {
    super("");
    this.code = 6e3;
    this.name = "Unauthorized";
...
createErrorFromCodeLookup6.set(6e3, () => new UnauthorizedError3());
createErrorFromNameLookup6.set("Unauthorized", () => new UnauthorizedError3());
...
createErrorFromCodeLookup6.set(6001, () => new InvalidAmountError4());
createErrorFromNameLookup6.set("InvalidAmount", () => new InvalidAmountError4());
...
createErrorFromCodeLookup6.set(6002, () => new InvalidExecutorError());
...
createErrorFromCodeLookup6.set(6003, () => new ZeroMessageSizeError());
createErrorFromNameLookup6.set(
  "ZeroMessageSize",
...
createErrorFromCodeLookup6.set(6004, () => new InvalidRequiredDVNCountError());
createErrorFromNameLookup6.set(
...
createErrorFromCodeLookup6.set(6005, () => new InvalidOptionalDVNCountError());
createErrorFromNameLookup6.set(
...
createErrorFromCodeLookup6.set(
  6006,
...
createErrorFromCodeLookup6.set(6007, () => new InvalidConfirmationsError());
createErrorFromNameLookup6.set(
...
createErrorFromCodeLookup6.set(6008, () => new AtLeastOneDVNError());
createErrorFromNameLookup6.set("AtLeastOneDVN", () => new AtLeastOneDVNError());
...
createErrorFromCodeLookup6.set(6009, () => new UnsortedError());
createErrorFromNameLookup6.set("Unsorted", () => new UnsortedError());
...
createErrorFromCodeLookup6.set(6010, () => new InvalidTreasuryFeeCapError());
createErrorFromNameLookup6.set(
...
createErrorFromCodeLookup6.set(6011, () => new InvalidPacketVersionError());
createErrorFromNameLookup6.set(
...
createErrorFromCodeLookup6.set(6012, () => new InvalidEidError());
createErrorFromNameLookup6.set("InvalidEid", () => new InvalidEidError());
...
createErrorFromCodeLookup6.set(6013, () => new VerifyingError());
createErrorFromNameLookup6.set("Verifying", () => new VerifyingError());
...
createErrorFromCodeLookup6.set(6014, () => new InvalidWorkerIdError());
createErrorFromNameLookup6.set(
  "InvalidWorkerId",
...
createErrorFromCodeLookup6.set(6015, () => new InvalidOptionTypeError());
createErrorFromNameLookup6.set(
  "InvalidOptionType",
...
createErrorFromCodeLookup6.set(6016, () => new InvalidBpsError());
createErrorFromNameLookup6.set("InvalidBps", () => new InvalidBpsError());
...
createErrorFromCodeLookup6.set(6017, () => new ExceededMaxMessageSizeError());
createErrorFromNameLookup6.set(
...
createErrorFromCodeLookup6.set(6018, () => new InvalidExecutorProgramError());
createErrorFromNameLookup6.set(
...
createErrorFromCodeLookup6.set(6019, () => new InvalidAccountLengthError());
createErrorFromNameLookup6.set(
...
createErrorFromCodeLookup6.set(6020, () => new InvalidDvnProgramError());
createErrorFromNameLookup6.set(
  "InvalidDvnProgram",
...
createErrorFromCodeLookup6.set(6021, () => new InvalidDvnError());
createErrorFromNameLookup6.set("InvalidDvn", () => new InvalidDvnError());
...
createErrorFromCodeLookup6.set(6022, () => new LzTokenUnavailableError3());
createErrorFromNameLookup6.set(
  "LzTokenUnavailable",
...
createErrorFromCodeLookup6.set(6023, () => new InsufficientFeeError2());
createErrorFromNameLookup6.set(
  "InsufficientFee",
...
createErrorFromCodeLookup6.set(6024, () => new InvalidTreasuryError());
createErrorFromNameLookup6.set(
  "InvalidTreasury",
...
createErrorFromCodeLookup6.set(6025, () => new InvalidLzTokenMintError2());
createErrorFromNameLookup6.set(
  "InvalidLzTokenMint",
...
createErrorFromCodeLookup6.set(6026, () => new InvalidConfigTypeError2());
createErrorFromNameLookup6.set(
  "InvalidConfigType",
...
createErrorFromCodeLookup6.set(6027, () => new InvalidConfirmationError());
createErrorFromNameLookup6.set(
  "InvalidConfirmation",
...
createErrorFromCodeLookup6.set(6028, () => new InvalidType1SizeError());
createErrorFromNameLookup6.set(
  "InvalidType1Size",
...
createErrorFromCodeLookup6.set(6029, () => new InvalidType2SizeError());
createErrorFromNameLookup6.set(
  "InvalidType2Size",
...
createErrorFromCodeLookup6.set(6030, () => new ExceededU128Error());
createErrorFromNameLookup6.set("ExceededU128", () => new ExceededU128Error());
...
createErrorFromCodeLookup6.set(6031, () => new NonSignerError());
createErrorFromNameLookup6.set("NonSigner", () => new NonSignerError());
...
var commitVerificationStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createCommitVerificationInstruction(accounts, args, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
...
function createCommitVerificationInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
  const keys = [
    {
      pubkey: accounts.receiveConfig,
      isWritable: false,
...
var initConfigParamsBeet3 = new beet201__namespace.BeetArgsStruct(
  [
    ["oapp", beetSolana97__namespace.publicKey],
    ["eid", beet201__namespace.u32]
  ],
...
var initConfigStruct3 = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitConfigInstruction3(accounts, args, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
...
function createInitConfigInstructionAccounts3(accounts, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
  const keys = [
    {
      pubkey: accounts.endpoint,
      isWritable: false,
...
var initDefaultConfigParamsBeet2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
...
var initDefaultConfigStruct2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitDefaultConfigInstruction2(accounts, args, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
...
function createInitDefaultConfigInstructionAccounts2(accounts, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: true,
...
var initUlnParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["endpoint", beetSolana97__namespace.publicKey],
    ["endpointProgram", beetSolana97__namespace.publicKey],
...
var initUlnStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitUlnInstruction(accounts, args, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
...
function createInitUlnInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
  const keys = [
    {
      pubkey: accounts.payer,
      isWritable: true,
...
var initVerifyParamsBeet2 = new beet201__namespace.BeetArgsStruct(
  [
    ["packetHeader", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 81)],
    ["payloadHash", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["dvn", beetSolana97__namespace.publicKey]
...
var initVerifyStruct2 = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitVerifyInstruction2(accounts, args, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
...
function createInitVerifyInstructionAccounts2(accounts, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
  const keys = [
    {
      pubkey: accounts.payer,
      isWritable: true,
...
var packetBeet2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["nonce", beet201__namespace.u64],
    ["srcEid", beet201__namespace.u32],
    ["sender", beetSolana97__namespace.publicKey],
...
var quoteParamsBeet4 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["packet", packetBeet2],
    ["options", beet201__namespace.bytes],
    ["payInLzToken", beet201__namespace.bool]
...
var quoteStruct4 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createQuoteInstruction4(accounts, args, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
...
function createQuoteInstructionAccounts4(accounts, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
  const keys = [
    {
      pubkey: accounts.endpoint,
      isWritable: false,
...
var sendParamsBeet4 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["packet", packetBeet2],
    ["options", beet201__namespace.bytes],
    ["nativeFee", beet201__namespace.u64]
...
var sendStruct4 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSendInstruction4(accounts, args, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
...
function createSendInstructionAccounts4(accounts, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
  const keys = [
    {
      pubkey: accounts.endpoint,
      isWritable: false,
...
var sendWithLzTokenParamsBeet2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["packet", packetBeet2],
    ["options", beet201__namespace.bytes],
    ["nativeFee", beet201__namespace.u64],
...
var sendWithLzTokenStruct2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSendWithLzTokenInstruction2(accounts, args, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
...
function createSendWithLzTokenInstructionAccounts2(accounts, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
  const keys = [
    {
      pubkey: accounts.endpoint,
      isWritable: false,
...
var setConfigParamsBeet4 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["oapp", beetSolana97__namespace.publicKey],
    ["eid", beet201__namespace.u32],
    ["configType", beet201__namespace.u32],
...
var setConfigStruct4 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetConfigInstruction4(accounts, args, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
...
function createSetConfigInstructionAccounts4(accounts, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
  const keys = [
    {
      pubkey: accounts.endpoint,
      isWritable: false,
...
var setDefaultConfigParamsBeet2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["sendUlnConfig", beet201__namespace.coption(ulnConfigBeet2)],
    ["receiveUlnConfig", beet201__namespace.coption(ulnConfigBeet2)],
...
var setDefaultConfigStruct2 = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetDefaultConfigInstruction2(accounts, args, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
...
function createSetDefaultConfigInstructionAccounts2(accounts, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var setTreasuryParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [["treasury", beet201__namespace.coption(treasuryBeet)]],
  "SetTreasuryParams"
);

// src/generated/uln/instructions/setTreasury.ts
var setTreasuryStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetTreasuryInstruction(accounts, args, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
...
function createSetTreasuryInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
  const keys = [
    {
      pubkey: accounts.signer,
      isWritable: false,
...
var transferAdminParamsBeet4 = new beet201__namespace.BeetArgsStruct(
  [["admin", beetSolana97__namespace.publicKey]],
  "TransferAdminParams"
);

// src/generated/uln/instructions/transferAdmin.ts
var transferAdminStruct4 = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createTransferAdminInstruction4(accounts, args, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
...
function createTransferAdminInstructionAccounts4(accounts, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var verifyParamsBeet2 = new beet201__namespace.BeetArgsStruct(
  [
    ["packetHeader", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 81)],
    ["payloadHash", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 32)],
    ["confirmations", beet201__namespace.u64]
...
var verifyStruct2 = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createVerifyInstruction2(accounts, args, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
...
function createVerifyInstructionAccounts2(accounts, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
  const keys = [
    {
      pubkey: accounts.dvn,
      isWritable: false,
...
var versionStruct3 = new beet201__namespace.BeetArgsStruct(
  [["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)]],
  "VersionInstructionArgs"
);
...
function createVersionInstruction3(programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
...
function createVersionInstructionAccounts3(programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
  const keys = [];
  return keys;
}
var withdrawRentParamsBeet2 = new beet201__namespace.BeetArgsStruct(
  [["amount", beet201__namespace.u64]],
  "WithdrawRentParams"
);

// src/generated/uln/instructions/withdrawRent.ts
var withdrawRentStruct2 = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createWithdrawRentInstruction2(accounts, args, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
...
function createWithdrawRentInstructionAccounts2(accounts, programId = new web35__namespace.PublicKey("7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var messagingFeeBeet4 = new beet201__namespace.BeetArgsStruct(
  [
    ["nativeFee", beet201__namespace.u64],
    ["lzTokenFee", beet201__namespace.u64]
  ],
...
var versionBeet3 = new beet201__namespace.BeetArgsStruct(
  [
    ["major", beet201__namespace.u64],
    ["minor", beet201__namespace.u8],
    ["endpointVersion", beet201__namespace.u8]
...
var PROGRAM_ADDRESS6 = "7a4WjyR8VZ7yZz5XJAKm39BUGn5iT9CKcv2pmG9tdXVH";
var PROGRAM_ID6 = new web35.PublicKey(PROGRAM_ADDRESS6);
...
var Uln = class {
  ...
  async getQuoteIXAccountMetaForCPI(connection, _payer, path, commitment) {
    ...
    const [setting] = this.deriver.setting();
    const executorAccounts = await new Executor(executorProgram).getQuoteIXAccountMetaForCPI(
      connection,
      false,
      commitment
    );
    ...
    const accounts = createQuoteInstructionAccounts4(
      {
        endpoint: web35.PublicKey.default,
        // useless
        uln: setting,
  ...
  async getSendIXAccountMetaForCPI(connection, payer, path, commitment = "confirmed") {
    ...
    const accounts = createSendInstructionAccounts4({
      endpoint: web35.PublicKey.default,
      // useless
      uln: setting,
      sendConfig,
   ...
   */
  async getWorkerPrograms(connection, sender, eid, commitment = "confirmed") {
    ...
    if (sendConfigState?.executor && !sendConfigState.executor.executor.equals(web35.PublicKey.default)) {
    ...
    if (sendConfigState && sendConfigState.uln.requiredDvns.length > 0) {
      requiredDvns = sendConfigState.uln.requiredDvns.filter((p) => {
        return !p.equals(web35.PublicKey.default);
      });
    }
    ...
    return createVerifyInstruction2(
      ...
      },
      {
        params: {
          packetHeader: Array.from(Uint8Array.from(Buffer.from(packet.header().slice(2), "hex"))),
          payloadHash: Array.from(payloadHashBytes),
          confirmations: typeof confirmations === "string" ? new BN6__default.default(confirmations) : confirmations
        }
      },
      this.program
    );
...
var modelTypeBeet = beet201__namespace.dataEnum([
  [
    "Arbitrum",
    new beet201__namespace.BeetArgsStruct(
      [
        ["gasPerL2Tx", beet201__namespace.u64],
        ["gasPerL1CalldataByte", beet201__namespace.u32]
      ],
...
var priceBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["eid", beet201__namespace.u32],
    ["priceRatio", beet201__namespace.u128],
    ["gasPriceInUnit", beet201__namespace.u64],
    ["gasPerByte", beet201__namespace.u32],
    ["modelType", beet201__namespace.coption(modelTypeBeet)]
  ],
  "Price"
);
...
var PriceFeed = class _PriceFeed {
  ...
  static gpaBuilder(programId = new web35__namespace.PublicKey(
    ...
    return beetSolana97__namespace.GpaBuilder.fromStruct(programId, priceFeedBeet);
  }
  /**
...
var priceFeedBeet = new beet201__namespace.FixableBeetStruct(
  [
    ["accountDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
    ["admin", beetSolana97__namespace.publicKey],
    ["updaters", beet201__namespace.array(beetSolana97__namespace.publicKey)],
    ["priceRatioDenominator", beet201__namespace.u128],
    ["arbitrumCompressionPercent", beet201__namespace.u128],
    ["nativeTokenPriceUsd", beet201__namespace.coption(beet201__namespace.u128)],
    ["prices", beet201__namespace.array(priceBeet)],
    ["bump", beet201__namespace.u8]
  ],
  PriceFeed.fromArgs,
  "PriceFeed"
...
var getFeeParamsBeet = new beet201__namespace.BeetArgsStruct(
  [
    ["dstEid", beet201__namespace.u32],
    ["calldataSize", beet201__namespace.u64],
    ["totalGas", beet201__namespace.u128]
  ],
  "GetFeeParams"
);

// src/generated/pricefeed/instructions/getFee.ts
var getFeeStruct = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createGetFeeInstruction(accounts, args, programId = new web35__namespace.PublicKey("8ahPGPjEbpgGaZx2NV1iG5Shj7TDwvsjkEDcGWjt94TP")) {
...
function createGetFeeInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("8ahPGPjEbpgGaZx2NV1iG5Shj7TDwvsjkEDcGWjt94TP")) {
  const keys = [
    {
      pubkey: accounts.priceFeed,
      isWritable: false,
...
var initPriceFeedParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["admin", beetSolana97__namespace.publicKey],
    ["updaters", beet201__namespace.array(beetSolana97__namespace.publicKey)]
  ],
...
var initPriceFeedStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createInitPriceFeedInstruction(accounts, args, programId = new web35__namespace.PublicKey("8ahPGPjEbpgGaZx2NV1iG5Shj7TDwvsjkEDcGWjt94TP")) {
...
function createInitPriceFeedInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("8ahPGPjEbpgGaZx2NV1iG5Shj7TDwvsjkEDcGWjt94TP")) {
  const keys = [
    {
      pubkey: accounts.payer,
      isWritable: true,
...
var priceParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["priceRatio", beet201__namespace.u128],
    ["gasPriceInUnit", beet201__namespace.u64],
    ["gasPerByte", beet201__namespace.u32],
...
var setPriceParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["dstEid", beet201__namespace.u32],
    ["params", beet201__namespace.coption(priceParamsBeet)]
  ],
  "SetPriceParams"
);

// src/generated/pricefeed/instructions/setPrice.ts
var setPriceStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetPriceInstruction(accounts, args, programId = new web35__namespace.PublicKey("8ahPGPjEbpgGaZx2NV1iG5Shj7TDwvsjkEDcGWjt94TP")) {
...
function createSetPriceInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("8ahPGPjEbpgGaZx2NV1iG5Shj7TDwvsjkEDcGWjt94TP")) {
  const keys = [
    {
      pubkey: accounts.updater,
      isWritable: false,
...
var setPriceFeedParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["updaters", beet201__namespace.array(beetSolana97__namespace.publicKey)],
    ["priceRatioDenominator", beet201__namespace.u128],
    ["arbitrumCompressionPercent", beet201__namespace.u128]
...
var setPriceFeedStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetPriceFeedInstruction(accounts, args, programId = new web35__namespace.PublicKey("8ahPGPjEbpgGaZx2NV1iG5Shj7TDwvsjkEDcGWjt94TP")) {
...
function createSetPriceFeedInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("8ahPGPjEbpgGaZx2NV1iG5Shj7TDwvsjkEDcGWjt94TP")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: true,
...
var setSolPriceParamsBeet = new beet201__namespace.FixableBeetArgsStruct(
  [["nativeTokenPriceUsd", beet201__namespace.coption(beet201__namespace.u128)]],
  "SetSolPriceParams"
);

// src/generated/pricefeed/instructions/setSolPrice.ts
var setSolPriceStruct = new beet201__namespace.FixableBeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createSetSolPriceInstruction(accounts, args, programId = new web35__namespace.PublicKey("8ahPGPjEbpgGaZx2NV1iG5Shj7TDwvsjkEDcGWjt94TP")) {
...
function createSetSolPriceInstructionAccounts(accounts, programId = new web35__namespace.PublicKey("8ahPGPjEbpgGaZx2NV1iG5Shj7TDwvsjkEDcGWjt94TP")) {
  const keys = [
    {
      pubkey: accounts.updater,
      isWritable: false,
...
var transferAdminParamsBeet5 = new beet201__namespace.BeetArgsStruct(
  [["admin", beetSolana97__namespace.publicKey]],
  "TransferAdminParams"
);

// src/generated/pricefeed/instructions/transferAdmin.ts
var transferAdminStruct5 = new beet201__namespace.BeetArgsStruct(
  [
    ["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)],
...
function createTransferAdminInstruction5(accounts, args, programId = new web35__namespace.PublicKey("8ahPGPjEbpgGaZx2NV1iG5Shj7TDwvsjkEDcGWjt94TP")) {
...
function createTransferAdminInstructionAccounts5(accounts, programId = new web35__namespace.PublicKey("8ahPGPjEbpgGaZx2NV1iG5Shj7TDwvsjkEDcGWjt94TP")) {
  const keys = [
    {
      pubkey: accounts.admin,
      isWritable: false,
...
var createErrorFromCodeLookup7 = /* @__PURE__ */ new Map();
var createErrorFromNameLookup7 = /* @__PURE__ */ new Map();
...
createErrorFromCodeLookup7.set(6e3, () => new TooManyUpdatersError());
createErrorFromNameLookup7.set(
  "TooManyUpdaters",
...
createErrorFromCodeLookup7.set(6001, () => new InvalidUpdaterError());
createErrorFromNameLookup7.set("InvalidUpdater", () => new InvalidUpdaterError());
...
createErrorFromCodeLookup7.set(6002, () => new NotFoundError());
createErrorFromNameLookup7.set("NotFound", () => new NotFoundError());
...
createErrorFromCodeLookup7.set(6003, () => new InvalidSizeError2());
createErrorFromNameLookup7.set("InvalidSize", () => new InvalidSizeError2());

// src/generated/pricefeed/index.ts
var PROGRAM_ADDRESS7 = "8ahPGPjEbpgGaZx2NV1iG5Shj7TDwvsjkEDcGWjt94TP";
var PROGRAM_ID7 = new web35.PublicKey(PROGRAM_ADDRESS7);
...
var PriceFeed2 = class {
  ...
  transferAdmin(admin, newAdmin) {
    const [priceFeed] = this.deriver.priceFeed();
    return createTransferAdminInstruction5(
      {
        admin,
        priceFeed
      },
...
async function createInitNativeOftIx(payer, admin, mint, oftMintAuthority, lzDelegate, sharedDecimals = 6, tokenProgram = splToken.TOKEN_PROGRAM_ID) {
  const [oftConfig] = web35.PublicKey.findProgramAddressSync(
...
async function createSetPeerIx(admin, oftConfig, dstEid, peer) {
  ...
  const [peerPda] = web35.PublicKey.findProgramAddressSync(
    [Buffer.from(PEER_SEED2, "utf-8"), oftConfig.toBuffer(), new BN6__default.default(dstEid).toArrayLike(Buffer, "be", 4)],
    PROGRAM_ID
  );
...
async function createSetSendLibraryIx(signer, oftConfig, sendLibraryProgram, dstEid) {
  const [newSendLib] = web35.PublicKey.findProgramAddressSync([Buffer.from(MESSAGE_LIB_SEED2, "utf8")], sendLibraryProgram);
  const [oAppRegistry] = web35.PublicKey.findProgramAddressSync(
    [Buffer.from(OAPP_SEED2, "utf-8"), oftConfig.toBuffer()],
    PROGRAM_ID2
  );
  ...
  const [sendLibraryInfo] = web35.PublicKey.findProgramAddressSync(
...
async function createSetReceiveLibraryIx(signer, oftConfig, receiveLibraryProgram, dstEid, gracePeriod) {
  const [newReceiveLib] = web35.PublicKey.findProgramAddressSync(
...
async function createMintToIx(signer, tokenMint, tokenDest, amount, tokenProgram = splToken.TOKEN_PROGRAM_ID) {
  ...
  return createMintToInstruction(
    ...
    {
      params: {
        amount: new BN6__default.default(amount.toString())
      }
    },
    PROGRAM_ID
  );
...
async function createSetRateLimitIx(signer, oftConfig, dstEid, capacity, refillPerSecond, enabled) {
  const [peer] = web35.PublicKey.findProgramAddressSync(
    [Buffer.from(PEER_SEED2, "utf-8"), oftConfig.toBytes(), new BN6__default.default(dstEid).toArrayLike(Buffer, "be", 4)],
    PROGRAM_ID
  );
  return createSetRateLimitInstruction(
    ...
    },
    {
      params: {
        dstEid,
        capacity: new BN6__default.default(capacity.toString()),
        refillPerSecond: new BN6__default.default(refillPerSecond.toString()),
        enabled
      }
    },
    PROGRAM_ID
...
async function createSetEnforcedOptionsIx(admin, oftConfig, dstEid, sendOptions, sendAndCallOptions) {
  const [enforcedOptions] = web35.PublicKey.findProgramAddressSync(
    [Buffer.from(ENFORCED_OPTIONS_SEED2, "utf-8"), oftConfig.toBytes(), new BN6__default.default(dstEid).toArrayLike(Buffer, "be", 4)],
    PROGRAM_ID
  );
...
async function sendWithUln(connection, payer, tokenMint, tokenSource, dstEid, amountLd, minAmountLd, options, to, nativeFee, tokenEscrow = void 0, lzTokenFee = 0n, tokenProgram = splToken.TOKEN_PROGRAM_ID, composeMsg = null) {
  const [oftInstance] = web35.PublicKey.findProgramAddressSync(
...
async function createInitNonceIx(delegate, dstEid, oftInstance, remoteOappAddr) {
  const [nonce] = web35.PublicKey.findProgramAddressSync(
    [Buffer.from(NONCE_SEED2), oftInstance.toBuffer(), new BN6__default.default(dstEid).toArrayLike(Buffer, "be", 4), remoteOappAddr],
    PROGRAM_ID2
  );
...
async function quoteWithUln(connection, payer, tokenMint, dstEid, amountLd, minAmountLd, options, to, tokenEscrow = void 0, payInLzToken = false, composeMsg = null) {
  ...
  const modifyComputeUnits = web35.ComputeBudgetProgram.setComputeUnitLimit({
    units: 1e6
  });
...
async function getEndpointConfig(connection, oftInstance, dstEid) {
  const [sendLib] = web35.PublicKey.findProgramAddressSync(
    [
      Buffer.from(SEND_LIBRARY_CONFIG_SEED2, "utf-8"),
      oftInstance.toBuffer(),
      new BN6__default.default(dstEid).toArrayLike(Buffer, "be", 4)
  ...
  const [defaultSendLib] = web35.PublicKey.findProgramAddressSync(
    [Buffer.from(SEND_LIBRARY_CONFIG_SEED2, "utf-8"), new BN6__default.default(dstEid).toArrayLike(Buffer, "be", 4)],
    PROGRAM_ID2
  );
  ...
  if (sendLibraryConfig.messageLib.equals(ulnSettings)) {
    const [ulnDefaultSendConfigPDA] = web35.PublicKey.findProgramAddressSync(
      [Buffer.from(SEND_CONFIG_SEED2, "utf-8"), new BN6__default.default(dstEid).toArrayLike(Buffer, "be", 4)],
      PROGRAM_ID6
    );
    ...
    if (nil64.eq(new BN6__default.default(ulnSendConfig.uln.confirmations.toString()))) {
  ...
  if (receiveLibraryConfig.messageLib.equals(ulnSettings)) {
    const [ulnDefaultReceiveConfigPDA] = web35.PublicKey.findProgramAddressSync(
      [Buffer.from(SEND_CONFIG_SEED2, "utf-8"), new BN6__default.default(dstEid).toArrayLike(Buffer, "be", 4)],
      PROGRAM_ID6
    );
    ...
    if (nil64.eq(new BN6__default.default(ulnReceiveConfig.uln.confirmations.toString()))) {
...
async function getDelegate(connection, oftInstance) {
  ...
  return new web35.PublicKey(oAppRegistryInfo.data.subarray(8, 40));
}
...
function getProgramKeypair(network, program) {
  ...
  return new web35.PublicKey(deployment.address);
}
...
__export(blocked_messagelib_exports, {
  PROGRAM_ADDRESS: () => PROGRAM_ADDRESS8,
  PROGRAM_ID: () => PROGRAM_ID8,
...
var versionStruct4 = new beet201__namespace.BeetArgsStruct(
  [["instructionDiscriminator", beet201__namespace.uniformFixedSizeArray(beet201__namespace.u8, 8)]],
  "VersionInstructionArgs"
);
...
function createVersionInstruction4(programId = new web35__namespace.PublicKey("2XrYqmhBMPJgDsb4SVbjV1PnJBprurd5bzRCkHwiFCJB")) {
...
function createVersionInstructionAccounts4(programId = new web35__namespace.PublicKey("2XrYqmhBMPJgDsb4SVbjV1PnJBprurd5bzRCkHwiFCJB")) {
  const keys = [];
  return keys;
}

// src/generated/blocked_messagelib/index.ts
var PROGRAM_ADDRESS8 = "2XrYqmhBMPJgDsb4SVbjV1PnJBprurd5bzRCkHwiFCJB";
var PROGRAM_ID8 = new web35.PublicKey(PROGRAM_ADDRESS8);
...
exports.OftTools = OftTools_exports;
