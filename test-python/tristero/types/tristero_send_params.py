...
class TristeroSendParamsJSON(typing.TypedDict):
    dst_eid: int
    receiver: list[int]
    message: list[int]
    options: list[int]
...
class TristeroSendParams:
    ...
    @classmethod
    def from_decoded(cls, obj: Container) -> "TristeroSendParams":
        return cls(
            dst_eid=obj.dst_eid,
    ...
    def to_json(self) -> TristeroSendParamsJSON:
        return {
            "dst_eid": self.dst_eid,
            "receiver": self.receiver,
    ...
    @classmethod
    def from_json(cls, obj: TristeroSendParamsJSON) -> "TristeroSendParams":
        return cls(
            dst_eid=obj["dst_eid"],
            receiver=obj["receiver"],
